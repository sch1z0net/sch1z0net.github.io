...
const FFT_SIZES = [ 8, 16, 32, 64, 128, 256, 512, 1024, 2048 ];
...
$(document).ready(function(){
    ...
    let $numOpsLabel = $('<label for="numOpsSelect">').text("# Operations").appendTo($paramsDiv);
    let $runsLabel = $('<label for="runsSelect">').text("# Runs").appendTo($paramsDiv);
...
$(document).ready(async function(){
    ...
    $reload.click(async function(){
       ...
       document.querySelector("#section_main").scrollIntoView({behavior: 'smooth'});
