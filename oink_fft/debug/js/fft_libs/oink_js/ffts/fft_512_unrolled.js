...
function fftReal512(realInput) { 
    ...
    { 
     for (let j = 0; j < 8; j++) { 
         ...
         let oI = 0 + j + 8;
         if(j > 4){
             out512[eI * 2    ] =  out512[32 - eI * 2    ];
             out512[eI * 2 + 1] = -out512[32 - eI * 2 + 1];
             out512[oI * 2    ] =  out512[32 - oI * 2    ];
             out512[oI * 2 + 1] = -out512[32 - oI * 2 + 1];
             continue;
         } 
         let eRe  = out512[eI * 2    ];
    ...
    { 
     for (let j = 0; j < 16; j++) { 
         ...
         let oI = 0 + j + 16;
         if(j > 8){
             out512[eI * 2    ] =  out512[64 - eI * 2    ];
             out512[eI * 2 + 1] = -out512[64 - eI * 2 + 1];
             out512[oI * 2    ] =  out512[64 - oI * 2    ];
             out512[oI * 2 + 1] = -out512[64 - oI * 2 + 1];
             continue;
         } 
         let eRe  = out512[eI * 2    ];
         let eIm  = out512[eI * 2 + 1];
    ...
    { 
     for (let j = 0; j < 32; j++) { 
         ...
         let oI = 0 + j + 32;
         if(j > 16){
             out512[eI * 2    ] =  out512[128 - eI * 2    ];
             out512[eI * 2 + 1] = -out512[128 - eI * 2 + 1];
             out512[oI * 2    ] =  out512[128 - oI * 2    ];
             out512[oI * 2 + 1] = -out512[128 - oI * 2 + 1];
             continue;
         } 
         let eRe  = out512[eI * 2    ];
         let eIm  = out512[eI * 2 + 1];
