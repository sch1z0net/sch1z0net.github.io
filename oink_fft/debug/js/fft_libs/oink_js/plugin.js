...
const PLUGIN_OINK_js = {
  ...
  example:  function() { return perform_OINK_js(OINK_js.fftReal1024, testData.slice()).slice(); },
  init: async function() { },
  ...
  example:  function(testData) { return perform_OINK_js(OINK_js.fftReal1024,  testData); },
};
