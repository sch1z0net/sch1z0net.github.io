...
let testData = new Float32Array([1.0, 0.5, 0.0, -0.5, -1.0, -0.5, 0.0, 0.5, 1.0, 0.5, 0.0, -0.5, -1.0, -0.5, 0.0, 0.5]); //16
//let testData = new Float32Array([1.0, 0.5, 0.2, -0.2, -1.0, -0.5, 0.6, 0.5]);
