...
function plotSpectrumLive(frequencyData = null, sampleRate = null) {
  ...
  if (frequencyData != null && sampleRate != null) {
    ...
    for (let x = 0; x < width; x++) {
      ...
      const binIndex = (logFrequency - logMinFrequency) / logScaleFactor * (numBins - 1); // Calculate bin index based on frequency
...
const frequency = 450; // Frequency of the sine wave in Hz
//max is 20k
