...
function fftComplexInPlace_seq_4(out) {
    ...
    for(let i = 0; i < tsq*4; i+=16){
          ...
          resReB = x0bRe  + x1bRe * tRe_1b - x1bIm * tRe_1b + x2bRe * tRe_2b + (x3bRe-x3bIm) * tRe_1b2b - x2bIm * tRe_2d  - (x3bRe+x3bIm) * tRe_1b2d;                     out[i*2 +  2]  =   resReB;   out[i*2 +  30] =   resReB;
          resImB = x0bIm  + x1bRe * tRe_1b + x1bIm * tRe_1b + x2bRe * tRe_2d + (x3bRe-x3bIm) * tRe_1b2d + x2bIm * tRe_2b  + (x3bRe+x3bIm) * tRe_1b2b;                     out[i*2 +  3]  =   resImB;   out[i*2 +  31] = - resImB;
