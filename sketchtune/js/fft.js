        ...
        for(let i = 0; i < N; i+=4){
            ...
            */
            ...
            if(i<size1){                                                   //#################    +00\\\\\\\\\\\\\  |+04\\\\\\\\\\\\\  |-08\\\\\\\\\\\\\  |-12\\\\\\\\\\\\\                                
             ...
             // 12 <- 12 13  |||
             // 14 <- 14 15  |||
             console.log(i+0,"--->", ((0%size1+i)%N).padStart(2),       ".re =", "[",i_a0.padStart(2),"].re ",(sign1a<0)?"-":"+"," ([",i_a1.padStart(2),"].re * t[",j1a.padStart(2),"].re - [",i_a1.padStart(2),"].im * t[",j1a.padStart(2),"].im ) <-> ", "{",x0aRe.toFixed(2),"}",(sign1a<0)?"-":"+","({",x1aRe.toFixed(2),"} * t{",tRe_1a.toFixed(2),"} - {",x1aIm.toFixed(2),"} * {",tIm_1a.toFixed(2),"} ) = ",xM0ReA.toFixed(2));
             console.log(i+0,"--->", ((0%size1+i)+size1%N).padStart(2), ".re =", "[",i_a2.padStart(2),"].re ",(sign1a<0)?"-":"+"," ([",i_a3.padStart(2),"].re * t[",j1a.padStart(2),"].re - [",i_a3.padStart(2),"].im * t[",j1a.padStart(2),"].im ) <-> ", "{",x2aRe.toFixed(2),"}",(sign1a<0)?"-":"+","({",x3aRe.toFixed(2),"} * t{",tRe_1a.toFixed(2),"} - {",x3aIm.toFixed(2),"} * {",tIm_1a.toFixed(2),"} ) = ",xM2ReA.toFixed(2)); 
             ...
             // 13 <- 12 13  |||
             // 15 <- 14 15  |||
             console.log(i+1,"--->", ((1%size1+i)%N).padStart(2),       ".re =", "[",i_b0.padStart(2),"].re ",(sign1b<0)?"-":"+"," ([",i_b1.padStart(2),"].re * t[",j1b.padStart(2),"].re - [",i_b1.padStart(2),"].im * t[",j1b.padStart(2),"].im ) <-> ", "{",x0bRe.toFixed(2),"}",(sign1b<0)?"-":"+","({",x1bRe.toFixed(2),"} * t{",tRe_1b.toFixed(2),"} - {",x1bIm.toFixed(2),"} * {",tIm_1b.toFixed(2),"} ) = ",xM1ReB.toFixed(2));
             console.log(i+1,"--->", ((1%size1+i)+size1%N).padStart(2), ".re =", "[",i_b2.padStart(2),"].re ",(sign1b<0)?"-":"+"," ([",i_b3.padStart(2),"].re * t[",j1b.padStart(2),"].re - [",i_b3.padStart(2),"].im * t[",j1b.padStart(2),"].im ) <-> ", "{",x2bRe.toFixed(2),"}",(sign1b<0)?"-":"+","({",x3bRe.toFixed(2),"} * t{",tRe_1b.toFixed(2),"} - {",x3bIm.toFixed(2),"} * {",tIm_1b.toFixed(2),"} ) = ",xM3ReB.toFixed(2));  
             ...
             // 12 <- 12 13  |||
             // 14 <- 14 15  |||
             console.log(i+2,"--->", ((2%size1+i)%N).padStart(2),       ".re =", "[",i_c0.padStart(2),"].re ",(sign1c<0)?"-":"+"," ([",i_c1.padStart(2),"].re * t[",j1c.padStart(2),"].re - [",i_c1.padStart(2),"].im * t[",j1c.padStart(2),"].im ) <-> ", "{",x0cRe.toFixed(2),"}",(sign1c<0)?"-":"+","({",x1cRe.toFixed(2),"} * t{",tRe_1c.toFixed(2),"} - {",x1cIm.toFixed(2),"} * {",tIm_1c.toFixed(2),"} ) = ",xM0ReC.toFixed(2));  
             console.log(i+2,"--->", ((2%size1+i)+size1%N).padStart(2), ".re =", "[",i_c2.padStart(2),"].re ",(sign1c<0)?"-":"+"," ([",i_c3.padStart(2),"].re * t[",j1c.padStart(2),"].re - [",i_c3.padStart(2),"].im * t[",j1c.padStart(2),"].im ) <-> ", "{",x2cRe.toFixed(2),"}",(sign1c<0)?"-":"+","({",x3cRe.toFixed(2),"} * t{",tRe_1c.toFixed(2),"} - {",x3cIm.toFixed(2),"} * {",tIm_1c.toFixed(2),"} ) = ",xM2ReC.toFixed(2));
             ...
             // 13 <- 12 13  |||
             // 15 <- 14 15  |||
             console.log(i+3,"--->", ((3%size1+i)%N).padStart(2),       ".re =", "[",i_d0.padStart(2),"].re ",(sign1d<0)?"-":"+"," ([",i_d1.padStart(2),"].re * t[",j1d.padStart(2),"].re - [",i_d1.padStart(2),"].im * t[",j1d.padStart(2),"].im ) <-> ", "{",x0dRe.toFixed(2),"}",(sign1d<0)?"-":"+","({",x1dRe.toFixed(2),"} * t{",tRe_1d.toFixed(2),"} - {",x1dIm.toFixed(2),"} * {",tIm_1d.toFixed(2),"} ) = ",xM1ReD.toFixed(2)); 
             console.log(i+3,"--->", ((3%size1+i)+size1%N).padStart(2), ".re =", "[",i_d2.padStart(2),"].re ",(sign1d<0)?"-":"+"," ([",i_d3.padStart(2),"].re * t[",j1d.padStart(2),"].re - [",i_d3.padStart(2),"].im * t[",j1d.padStart(2),"].im ) <-> ", "{",x2dRe.toFixed(2),"}",(sign1d<0)?"-":"+","({",x3dRe.toFixed(2),"} * t{",tRe_1d.toFixed(2),"} - {",x3dIm.toFixed(2),"} * {",tIm_1d.toFixed(2),"} ) = ",xM3ReD.toFixed(2)); 
