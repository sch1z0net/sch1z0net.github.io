...
function fftComplexInPlace_seq_4(out) {
    ...
    for(let i_ = 0; i_ < tsq; i_+=2){
          ...
          x0aRe = out[(i+4)*2+0]; x0aIm = out[(i+4)*2+1];
          x1aRe = out[(i+5)*2+0]; x1aIm = out[(i+5)*2+1];
          x2aRe = out[(i+6)*2+0]; x2aIm = out[(i+6)*2+1];
          x3aRe = out[(i+7)*2+0]; x3aIm = out[(i+7)*2+1];
          
          xM0ReA = x0aRe + (x1aRe * tRe_1e - x1aIm * tIm_1e);
          xM0ImA = x0aIm + (x1aRe * tIm_1e + x1aIm * tRe_1e);                  
          xM2ReA = x2aRe + (x3aRe * tRe_1e - x3aIm * tIm_1e);
          xM2ImA = x2aIm + (x3aRe * tIm_1e + x3aIm * tRe_1e);
          
          xM1ReB = x0bRe - (x1bRe * tRe_1f - x1bIm * tIm_1f);
          xM1ImB = x0bIm - (x1bRe * tIm_1f + x1bIm * tRe_1f); 
          xM3ReB = x2bRe - (x3bRe * tRe_1f - x3bIm * tIm_1f);
          xM3ImB = x2bIm - (x3bRe * tIm_1f + x3bIm * tRe_1f);
          
          xM0ReC = x0cRe + (x1cRe * tRe_1g - x1cIm * tIm_1g);
          xM0ImC = x0cIm + (x1cRe * tIm_1g + x1cIm * tRe_1g); 
          xM2ReC = x2cRe + (x3cRe * tRe_1g - x3cIm * tIm_1g);
          xM2ImC = x2cIm + (x3cRe * tIm_1g + x3cIm * tRe_1g);
          
          xM1ReD = x0dRe - (x1dRe * tRe_1h - x1dIm * tIm_1h);
          xM1ImD = x0dIm - (x1dRe * tIm_1h + x1dIm * tRe_1h);
          xM3ReD = x2dRe - (x3dRe * tRe_1h - x3dIm * tIm_1h);
          xM3ImD = x2dIm - (x3dRe * tIm_1h + x3dIm * tRe_1h);

          out[(4+i)*2+0] = xM0ReA + ((xM2ReA)*tRe_2a - ((xM2ImA)*tIm_2a));
          out[(4+i)*2+1] = xM0ImA + ((xM2ReA)*tIm_2a + ((xM2ImA)*tRe_2a)); 
          out[(5+i)*2+0] = xM1ReB + ((xM3ReB)*tRe_2b - ((xM3ImB)*tIm_2b));
          out[(5+i)*2+1] = xM1ImB + ((xM3ReB)*tIm_2b + ((xM3ImB)*tRe_2b)); 
          out[(6+i)*2+0] = xM0ReC - ((xM2ReC)*tRe_2c - ((xM2ImC)*tIm_2c));
          out[(6+i)*2+1] = xM0ImC - ((xM2ReC)*tIm_2c + ((xM2ImC)*tRe_2c));
          out[(7+i)*2+0] = xM1ReD - ((xM3ReD)*tRe_2d - ((xM3ImD)*tIm_2d));
          out[(7+i)*2+1] = xM1ImD - ((xM3ReD)*tIm_2h + ((xM3ImD)*tRe_2d));
    } 
