...
function fftComplexInPlace_seq_4(out) {
    ...
    //
        ...
        for (let j = 0; j < halfSize; j++) {
            ...
            if(j > quarterSize){
              out[evenIndex * 2]     =  out[256 + 128 - evenIndex * 2] ;
              out[evenIndex * 2 + 1] = -out[256 + 128 - evenIndex * 2 + 1];
              out[oddIndex * 2]      =  out[256 + 128 - oddIndex * 2];
              out[oddIndex * 2 + 1]  = -out[256 + 128 - oddIndex * 2 + 1];
              continue;
            }
