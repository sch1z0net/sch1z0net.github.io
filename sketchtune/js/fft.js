...
function fftComplexInPlace_seq_4(out) {
    ...
    for(let i_ = 0; i_ < tsq; i_+=4){
          ...
          out[( 0+i)*2+0] = xM0ReA + xM2ReA; 
          //out[( 0+i)*2+1] = 0; 
          out[( 1+i)*2+0] = xM1ReB + ((xM3ReB)* tRe_2b - ((xM3ImB)*-tRe_2b));
          out[( 1+i)*2+1] = xM1ImB + ((xM3ReB)*-tRe_2b + ((xM3ImB)* tRe_2b)); 
          out[( 2+i)*2+0] = x0cRe  + ((x2cRe)*  tRe_2c - ((x3cRe)*  tRe_2c));
          out[( 2+i)*2+1] = x1cRe  + ((x2cRe)*  tRe_2c + ((x3cRe)*  tRe_2c));
          out[( 3+i)*2+0] = xM1ReD + ((xM3ReD)*-tRe_2b - ((xM3ImD)* tRe_2b));
          out[( 3+i)*2+1] = xM1ImD + ((xM3ReD)* tRe_2b + ((xM3ImD)*-tRe_2b));

          out[( 8+i)*2+0] = xM0ReA - xM2ReA;
          //out[( 8+i)*2+1] = 0;
          out[( 9+i)*2+0] = xM1ReB - ((xM3ReB)* tRe_2b - ((xM3ImB)*-tRe_2b));
          out[( 9+i)*2+1] = xM1ImB - ((xM3ReB)*-tRe_2b + ((xM3ImB)* tRe_2b)); 
          out[(10+i)*2+0] = x0cRe  - ((x2cRe)*  tRe_2c - ((x3cRe)*  tRe_2c));
          out[(10+i)*2+1] = x1cRe  - ((x2cRe)*  tRe_2c + ((x3cRe)*  tRe_2c));
          out[(11+i)*2+0] = xM1ReD - ((xM3ReD)*-tRe_2b - ((xM3ImD)* tRe_2b));
          out[(11+i)*2+1] = xM1ImD - ((xM3ReD)* tRe_2b + ((xM3ImD)*-tRe_2b));
