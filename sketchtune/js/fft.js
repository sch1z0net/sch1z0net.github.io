...
function fftComplexInPlace_seq_4(out) {
    ...
    tRe_2b_  = -tIm_2b; //____F[62+(17*2+0)]; 
    tIm_2b_  =  tIm_2b; //____F[62+(17*2+1)];
    tRe_2c_  = -tIm_2c; //____F[62+(18*2+0)]; 
    tIm_2c_  =  tIm_2c; //____F[62+(18*2+1)];
    tRe_2d_  = -tIm_2d; //____F[62+(19*2+0)]; 
    tIm_2d_  =  tIm_2d; //____F[62+(19*2+1)];
    tRe_2e_  = -tIm_2e; //____F[62+(20*2+0)];
    tIm_2e_  =  tIm_2e; //____F[62+(20*2+1)];
    tRe_2f_  = -tIm_2f; //____F[62+(21*2+0)]; 
    tIm_2f_  =  tIm_2f; //____F[62+(21*2+1)];
    tRe_2g_  = -tIm_2g; //____F[62+(22*2+0)]; 
    tIm_2g_  =  tIm_2g; //____F[62+(22*2+1)];
    tRe_2h_  = -tIm_2h; //____F[62+(23*2+0)]; 
    tIm_2h_  =  tIm_2h; //____F[62+(23*2+1)];
    tRe_2i_  = -tIm_2i; //____F[62+(24*2+0)];
    tIm_2i_  =  tIm_2i; //____F[62+(24*2+1)];
    tRe_2j_  = -tIm_2j; //____F[62+(25*2+0)]; 
    tIm_2j_  =  tIm_2j; //____F[62+(25*2+1)];
    tRe_2k_  = -tIm_2k; //____F[62+(26*2+0)]; 
    tIm_2k_  =  tIm_2k; //____F[62+(26*2+1)];
    tRe_2l_  = -tIm_2l; //____F[62+(27*2+0)]; 
    tIm_2l_  =  tIm_2l; //____F[62+(27*2+1)];
    tRe_2m_  = -tIm_2m; //____F[62+(28*2+0)];
    tIm_2m_  =  tIm_2m; //____F[62+(28*2+1)];
    tRe_2n_  = -tIm_2n; //____F[62+(29*2+0)]; 
    tIm_2n_  =  tIm_2n; //____F[62+(29*2+1)]; 
    tRe_2o_  = -tIm_2o; //____F[62+(30*2+0)]; 
    tIm_2o_  =  tIm_2o; //____F[62+(30*2+1)];
    tRe_2p_  = -tIm_2p; //____F[62+(31*2+0)]; 
    tIm_2p_  =  tIm_2p; //____F[62+(31*2+1)];
    ...
    for(let i_ = 0; i_ < tsq; i_+=16){
          ...
          out[(33+i)*2+0] = xM1ReB + (xM3ReB)*tIm_2b - (xM3ImB)*tIm_2b;
                          //xM1ReB - (xM3ReB)*tIm_2b + (xM3ImB)*tIm_2b;
