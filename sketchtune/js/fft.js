...
function fftComplexInPlace_seq_4(out) {
    ...
    for(let i_ = 0; i_ < tsq; i_++){
          ...
          xM0ImA = x0aIm + (x1aRe * tIm_1a + x1aIm * tRe_1a);  // is 0                  
          xM2ReA = x2aRe + (x3aRe * tRe_1a - x3aIm * tIm_1a);  // x2aRe + x3aRe
          xM2ImA = x2aIm + (x3aRe * tIm_1a + x3aIm * tRe_1a);  // is 0    
          
          xM1ReB = x0aRe - (x1aRe * tRe_1a - x1aIm * tIm_1a);  // x0aRe - x1aRe  
          xM1ImB = x0aIm - (x1aRe * tIm_1a + x1aIm * tRe_1a);  // is 0
          xM3ReB = x2aRe - (x3aRe * tRe_1a - x3aIm * tIm_1a);  // x2aRe - x3aRe
          xM3ImB = x2aIm - (x3aRe * tIm_1a + x3aIm * tRe_1a);  // is 0
          */
          ...
          out[(2+i)*2+0] = xM0ReA - ((xM2ReA)*tRe_2a - ((xM2ImA)*tIm_2a));
    ...
    tIm_2g  = ____F[14+(6*2+1)];
    tRe_2h  = ____F[14+(7*2+0)]; 
    tIm_2h  = ____F[14+(7*2+1)];

    for(let i_ = 0; i_ < tsq; i_+=4){
          let i = i_ * 4;

          x0aRe = out[(i+ 0)*2+0]; //x0aIm = out[(i+ 0)*2+1];  //OLDxM0ReA + OLDxM2ReA
          x1aRe = out[(i+ 4)*2+0]; //x1aIm = out[(i+ 4)*2+1];  //OLDxM0ReA + OLDxM2ReA
          x2aRe = out[(i+ 8)*2+0]; //x2aIm = out[(i+ 8)*2+1];  //OLDxM0ReA + OLDxM2ReA
          x3aRe = out[(i+12)*2+0]; //x3aIm = out[(i+12)*2+1];  //OLDxM0ReA + OLDxM2ReA
          
          x0bRe = out[(i+ 1)*2+0]; x0bIm = out[(i+ 1)*2+1];  //OLDxM1ReB    OLDxM3ReB
          x1bRe = out[(i+ 5)*2+0]; x1bIm = out[(i+ 5)*2+1];  //OLDxM1ReB    OLDxM3ReB
          x2bRe = out[(i+ 9)*2+0]; x2bIm = out[(i+ 9)*2+1];  //OLDxM1ReB    OLDxM3ReB
          x3bRe = out[(i+13)*2+0]; x3bIm = out[(i+13)*2+1];  //OLDxM1ReB    OLDxM3ReB
          ...
          out[( 1+i)*2+0] = xM1ReB + ((xM3ReB)*tRe_2b - ((xM3ImB)*tIm_2b));
          out[( 1+i)*2+1] = xM1ImB + ((xM3ReB)*tIm_2b + ((xM3ImB)*tRe_2b)); 
          out[( 2+i)*2+0] = x0cRe  + ((x2cRe)*tRe_2c - ((x3cRe)*tIm_2c));
          out[( 2+i)*2+1] = x1cRe  + ((x2cRe)*tIm_2c + ((x3cRe)*tRe_2c));
          out[( 3+i)*2+0] = xM1ReD + ((xM3ReD)*tRe_2d - ((xM3ImD)*tIm_2d));
          out[( 3+i)*2+1] = xM1ImD + ((xM3ReD)*tIm_2d + ((xM3ImD)*tRe_2d));

          out[( 8+i)*2+0] = xM0ReA - xM2ReA;
          //out[( 8+i)*2+1] = 0;
          out[( 9+i)*2+0] = xM1ReB - ((xM3ReB)*tRe_2b - ((xM3ImB)*tIm_2b));
          out[( 9+i)*2+1] = xM1ImB - ((xM3ReB)*tIm_2b + ((xM3ImB)*tRe_2b)); 
          out[(10+i)*2+0] = x0cRe  - ((x2cRe)*tRe_2c - ((x3cRe)*tIm_2c));
          out[(10+i)*2+1] = x1cRe  - ((x2cRe)*tIm_2c + ((x3cRe)*tRe_2c));
          out[(11+i)*2+0] = xM1ReD - ((xM3ReD)*tRe_2d - ((xM3ImD)*tIm_2d));
          out[(11+i)*2+1] = xM1ImD - ((xM3ReD)*tIm_2d + ((xM3ImD)*tRe_2d));
          ...
          out[(14+i)*2+0] =   x0cRe - ((x2cRe)*tRe_2g - ((-x3cRe)*tIm_2g));
          out[(14+i)*2+1] = - x1cRe - ((x2cRe)*tIm_2g + ((-x3cRe)*tRe_2g));
          out[(15+i)*2+0] = xM1ReD - ((xM3ReD)*tRe_2h - ((xM3ImD)*tIm_2h));
          out[(15+i)*2+1] = xM1ImD - ((xM3ReD)*tIm_2h + ((xM3ImD)*tRe_2h));
    }
    ...
    //tRe_1i   = ____F[30+(8*2+0)]; // 0
    /*tRe_1j   = -tRe_1h; //____F[30+(9*2+0)];
    tRe_1k   = -tRe_1g; //____F[30+(10*2+0)];
    tRe_1l   = -tRe_1f; //____F[30+(11*2+0)];
    tRe_1m   = -tRe_1e; //____F[30+(12*2+0)];
    tRe_1n   = -tRe_1d; //____F[30+(13*2+0)];
    tRe_1o   = -tRe_1c; //____F[30+(14*2+0)];
    tRe_1p   = -tRe_1b; //____F[30+(15*2+0)];

    //tIm_1a   = ____F[30+(0*2+1)]; // 0
    tIm_1b   = tRe_1h; //____F[30+(1*2+1)];
    tIm_1c   = tRe_1g; //____F[30+(2*2+1)];
    tIm_1d   = tRe_1f; //____F[30+(3*2+1)];
    tIm_1e   = tRe_1e; //____F[30+(4*2+1)];
    tIm_1f   = tRe_1d; //____F[30+(5*2+1)];
    tIm_1g   = tRe_1c; //____F[30+(6*2+1)]
    tIm_1h   = tRe_1b; //____F[30+(7*2+1)];
    //tIm_1i   = ____F[30+(8*2+1)]; // 1
    tIm_1j   = tRe_1b; //____F[30+(9*2+1)];
    tIm_1k   = tRe_1c; //____F[30+(10*2+1)];
    tIm_1l   = tRe_1d; //____F[30+(11*2+1)];
    tIm_1m   = tRe_1e; //____F[30+(12*2+1)];
    tIm_1n   = tRe_1f; //____F[30+(13*2+1)];
    tIm_1o   = tRe_1g; //____F[30+(14*2+1)];
    tIm_1p   = tRe_1h; //____F[30+(15*2+1)];*/
    ...
    /*
    //tRe_2a_  = ____F[62+(16*2+0)]; // 0
    tRe_2b_  = -tRe_2p; //____F[62+(17*2+0)]; 
    tRe_2c_  = -tRe_2o; //____F[62+(18*2+0)]; 
    tRe_2d_  = -tRe_2n; //____F[62+(19*2+0)]; 
    tRe_2e_  = -tRe_2m; //____F[62+(20*2+0)];
    tRe_2f_  = -tRe_2l; //____F[62+(21*2+0)]; 
    tRe_2g_  = -tRe_2k; //____F[62+(22*2+0)]; 
    tRe_2h_  = -tRe_2j; //____F[62+(23*2+0)]; 
    tRe_2i_  = -tRe_2i; //____F[62+(24*2+0)];
    tRe_2j_  = -tRe_2h; //____F[62+(25*2+0)]; 
    tRe_2k_  = -tRe_2g; //____F[62+(26*2+0)]; 
    tRe_2l_  = -tRe_2f; //____F[62+(27*2+0)]; 
    tRe_2m_  = -tRe_2e; //____F[62+(28*2+0)];
    tRe_2n_  = -tRe_2d; //____F[62+(29*2+0)]; 
    tRe_2o_  = -tRe_2c; //____F[62+(30*2+0)]; 
    tRe_2p_  = -tRe_2b; //____F[62+(31*2+0)]; 

    //tIm_2a   = ____F[62+(0*2+1)]; // 0
    tIm_2b   = tRe_2p; //____F[62+(1*2+1)];
    tIm_2c   = tRe_2o; //____F[62+(2*2+1)];
    tIm_2d   = tRe_2n; //____F[62+(3*2+1)];
    tIm_2e   = tRe_2m; //____F[62+(4*2+1)];
    tIm_2f   = tRe_2l; //____F[62+(5*2+1)];
    tIm_2g   = tRe_2k; //____F[62+(6*2+1)];
    tIm_2h   = tRe_2j; //____F[62+(7*2+1)];
    tIm_2i   = tRe_2i; //____F[62+(8*2+1)];
    tIm_2j   = tRe_2h; //____F[62+(9*2+1)];
    tIm_2k   = tRe_2g; //____F[62+(10*2+1)];
    tIm_2l   = tRe_2f; //____F[62+(11*2+1)];
    tIm_2m   = tRe_2e; //____F[62+(12*2+1)];
    tIm_2n   = tRe_2d; //____F[62+(13*2+1)];
    tIm_2o   = tRe_2c; //____F[62+(14*2+1)];
    tIm_2p   = tRe_2b; //____F[62+(15*2+1)];
    //tIm_2a_  = ____F[62+(16*2+1)]; // 1
    tIm_2b_  =  tRe_2b; //____F[62+(17*2+1)];
    tIm_2c_  =  tRe_2c; //____F[62+(18*2+1)];
    tIm_2d_  =  tRe_2d; //____F[62+(19*2+1)];
    tIm_2e_  =  tRe_2e; //____F[62+(20*2+1)];
    tIm_2f_  =  tRe_2f; //____F[62+(21*2+1)];
    tIm_2g_  =  tRe_2g; //____F[62+(22*2+1)];
    tIm_2h_  =  tRe_2h; //____F[62+(23*2+1)];
    tIm_2i_  =  tRe_2i; //____F[62+(24*2+1)];
    tIm_2j_  =  tRe_2j; //____F[62+(25*2+1)];
    tIm_2k_  =  tRe_2k; //____F[62+(26*2+1)];
    tIm_2l_  =  tRe_2l; //____F[62+(27*2+1)];
    tIm_2m_  =  tRe_2m; //____F[62+(28*2+1)];
    tIm_2n_  =  tRe_2n; //____F[62+(29*2+1)]; 
    tIm_2o_  =  tRe_2o; //____F[62+(30*2+1)];
    tIm_2p_  =  tRe_2p; //____F[62+(31*2+1)];
    */

    for(let i_ = 0; i_ < tsq; i_+=16){
          let i = i_ * 4;

          x0aRe_0 = out[(i+ 0)*2+0]; //x0aIm = out[(i+ 0)*2+1]; //0
          x1aRe_0 = out[(i+16)*2+0]; x1aIm_0 = out[(i+16)*2+1];
          x2aRe_0 = out[(i+32)*2+0]; x2aIm_0 = out[(i+32)*2+1];
          x3aRe_0 = out[(i+48)*2+0]; x3aIm_0 = out[(i+48)*2+1];
          
          x0bRe_0 = out[(i+ 1)*2+0]; x0bIm_0 = out[(i+ 1)*2+1];
          ...
          x0cRe_0 = out[(i+ 2)*2+0]; x0cIm_0 = out[(i+ 2)*2+1];
          ...
          x0dRe_0 = out[(i+ 3)*2+0]; x0dIm_0 = out[(i+ 3)*2+1];
          ...
          let Tx0aRe = x1aRe_0; //let Tx0aRe = (x1aRe * 1 - x1aIm * 0);
          let Tx0aIm = x1aIm_0; //let Tx0aIm = (x1aRe * 0 + x1aIm * 1);
          let Tx2aRe = x3aRe_0; //let Tx2aRe = (x3aRe * 1 - x3aIm * 0);
          let Tx2aIm = x3aIm_0; //let Tx2aIm = (x3aRe * 0 + x3aIm * 1);
          ...
          //xM2ReA = x2aRe + x3aRe; //xM2ReA = x2aRe + Tx2aRe;
          //xM2ImA = x2aIm + x3aIm; //xM2ImA = x2aIm + Tx2aIm; 
          ...
          //out[( 0+i)*2+0] = xM0ReA + ((xM2ReA)*1      - ((xM2ImA)*0     ));
          //out[( 0+i)*2+1] = xM0ImA + ((xM2ReA)*0      + ((xM2ImA)*1     )); 
          out[( 0+i)*2+0] = (x0aRe_0 + x1aRe_0) + (x2aRe_0 + x3aRe_0);
          out[( 0+i)*2+1] =            x1aIm_0  + (x2aIm_0 + x3aIm_0); 
          out[( 1+i)*2+0] = xM1ReB + ((xM3ReB)*  tRe_2b - ((xM3ImB)*  tRe_2p)); //
          out[( 1+i)*2+1] = xM1ImB + ((xM3ReB)*  tRe_2p + ((xM3ImB)*  tRe_2b)); //
          out[( 2+i)*2+0] = xM0ReC + ((xM2ReC)*  tRe_2c - ((xM2ImC)*  tRe_2o));
          out[( 2+i)*2+1] = xM0ImC + ((xM2ReC)*  tRe_2o + ((xM2ImC)*  tRe_2c)); 
          out[( 3+i)*2+0] = xM1ReD + ((xM3ReD)*  tRe_2d - ((xM3ImD)*  tRe_2n));
          out[( 3+i)*2+1] = xM1ImD + ((xM3ReD)*  tRe_2n + ((xM3ImD)*  tRe_2d));  
          ...
          out[(33+i)*2+0] = xM1ReB - ((xM3ReB)*  tRe_2b - ((xM3ImB)*  tRe_2p));
          out[(33+i)*2+1] = xM1ImB - ((xM3ReB)*  tRe_2p + ((xM3ImB)*  tRe_2b)); 
          out[(34+i)*2+0] = xM0ReC - ((xM2ReC)*  tRe_2c - ((xM2ImC)*  tRe_2o));
          out[(34+i)*2+1] = xM0ImC - ((xM2ReC)*  tRe_2o + ((xM2ImC)*  tRe_2c)); 
          out[(35+i)*2+0] = xM1ReD - ((xM3ReD)*  tRe_2d - ((xM3ImD)*  tRe_2n));
          out[(35+i)*2+1] = xM1ImD - ((xM3ReD)*  tRe_2n + ((xM3ImD)*  tRe_2d));
          ...
          //out[(16+i)*2+0] = xM0ReA + ((xM2ReA)*0       - ((xM2ImA)*1      ));
          //out[(16+i)*2+1] = xM0ImA + ((xM2ReA)*1       + ((xM2ImA)*0      )); 
          out[(16+i)*2+0] =   (x0aRe_0 - x1aRe_0) - (x2aIm_0 - x3aIm_0);
          out[(16+i)*2+1] =            - x1aIm_0  + (x2aRe_0 - x3aRe_0); 
          ...
          out[(19+i)*2+0] = xM1ReD + ((xM3ReD)* -tRe_2n  - ((xM3ImD)*  tRe_2d ));
          out[(19+i)*2+1] = xM1ImD + ((xM3ReD)*  tRe_2d  + ((xM3ImD)* -tRe_2n ));  

          //out[(48+i)*2+0] = xM0ReA - ((xM2ReA)*0       - ((xM2ImA)*1      ));
          //out[(48+i)*2+1] = xM0ImA - ((xM2ReA)*1       + ((xM2ImA)*0      )); 
          out[(48+i)*2+0] =   (x0aRe_0 - x1aRe_0) + (x2aIm_0 - x3aIm_0);
          out[(48+i)*2+1] =            - x1aIm_0  - (x2aRe_0 - x3aRe_0);
          out[(49+i)*2+0] = xM1ReB - ((xM3ReB)* -tRe_2p  - ((xM3ImB)*  tRe_2b ));
          out[(49+i)*2+1] = xM1ImB - ((xM3ReB)*  tRe_2b  + ((xM3ImB)* -tRe_2p )); 
          out[(50+i)*2+0] = xM0ReC - ((xM2ReC)* -tRe_2o  - ((xM2ImC)*  tRe_2c ));
          out[(50+i)*2+1] = xM0ImC - ((xM2ReC)*  tRe_2c  + ((xM2ImC)* -tRe_2o )); 
          out[(51+i)*2+0] = xM1ReD - ((xM3ReD)* -tRe_2n  - ((xM3ImD)*  tRe_2d ));
          out[(51+i)*2+1] = xM1ImD - ((xM3ReD)*  tRe_2d  + ((xM3ImD)* -tRe_2n ));

          x0aRe_4 = out[(4+ i+ 0)*2+0]; x0aIm_4 = out[(4+ i+ 0)*2+1]; //----> 12
          x1aRe_4 = out[(4+ i+16)*2+0]; x1aIm_4 = out[(4+ i+16)*2+1];
          x2aRe_4 = out[(4+ i+32)*2+0]; x2aIm_4 = out[(4+ i+32)*2+1];
          x3aRe_4 = out[(4+ i+48)*2+0]; x3aIm_4 = out[(4+ i+48)*2+1];
          
          x0bRe_4 = out[(4+ i+ 1)*2+0]; x0bIm_4 = out[(4+ i+ 1)*2+1]; //-----
          x1bRe_4 = out[(4+ i+17)*2+0]; x1bIm_4 = out[(4+ i+17)*2+1];
          x2bRe_4 = out[(4+ i+33)*2+0]; x2bIm_4 = out[(4+ i+33)*2+1];
          x3bRe_4 = out[(4+ i+49)*2+0]; x3bIm_4 = out[(4+ i+49)*2+1];
          
          x0cRe_4 = out[(4+ i+ 2)*2+0]; x0cIm_4 = out[(4+ i+ 2)*2+1]; //-----
          x1cRe_4 = out[(4+ i+18)*2+0]; x1cIm_4 = out[(4+ i+18)*2+1];
          x2cRe_4 = out[(4+ i+34)*2+0]; x2cIm_4 = out[(4+ i+34)*2+1];
          x3cRe_4 = out[(4+ i+50)*2+0]; x3cIm_4 = out[(4+ i+50)*2+1];
          
          x0dRe_4 = out[(4+ i+ 3)*2+0]; x0dIm_4 = out[(4+ i+ 3)*2+1]; //-----
          x1dRe_4 = out[(4+ i+19)*2+0]; x1dIm_4 = out[(4+ i+19)*2+1];
          ...
          out[( 4+i)*2+0] = xM0ReA + ((xM2ReA)*  tRe_2e - ((xM2ImA)*  tRe_2m));
          out[( 4+i)*2+1] = xM0ImA + ((xM2ReA)*  tRe_2m + ((xM2ImA)*  tRe_2e)); 
          out[( 5+i)*2+0] = xM1ReB + ((xM3ReB)*  tRe_2f - ((xM3ImB)*  tRe_2l));
          out[( 5+i)*2+1] = xM1ImB + ((xM3ReB)*  tRe_2l + ((xM3ImB)*  tRe_2f)); 
          out[( 6+i)*2+0] = xM0ReC + ((xM2ReC)*  tRe_2g - ((xM2ImC)*  tRe_2k));
          out[( 6+i)*2+1] = xM0ImC + ((xM2ReC)*  tRe_2k + ((xM2ImC)*  tRe_2g)); 
          out[( 7+i)*2+0] = xM1ReD + ((xM3ReD)*  tRe_2h - ((xM3ImD)*  tRe_2j));
          out[( 7+i)*2+1] = xM1ImD + ((xM3ReD)*  tRe_2j + ((xM3ImD)*  tRe_2h));

          out[(36+i)*2+0] = xM0ReA - ((xM2ReA)*  tRe_2e - ((xM2ImA)*  tRe_2m));
          out[(36+i)*2+1] = xM0ImA - ((xM2ReA)*  tRe_2m + ((xM2ImA)*  tRe_2e)); 
          out[(37+i)*2+0] = xM1ReB - ((xM3ReB)*  tRe_2f - ((xM3ImB)*  tRe_2l));
          out[(37+i)*2+1] = xM1ImB - ((xM3ReB)*  tRe_2l + ((xM3ImB)*  tRe_2f)); 
          out[(38+i)*2+0] = xM0ReC - ((xM2ReC)*  tRe_2g - ((xM2ImC)*  tRe_2k));
          out[(38+i)*2+1] = xM0ImC - ((xM2ReC)*  tRe_2k + ((xM2ImC)*  tRe_2g)); 
          out[(39+i)*2+0] = xM1ReD - ((xM3ReD)*  tRe_2h - ((xM3ImD)*  tRe_2j));
          out[(39+i)*2+1] = xM1ImD - ((xM3ReD)*  tRe_2j + ((xM3ImD)*  tRe_2h)); 
          ...
          out[(20+i)*2+0] = xM0ReA + ((xM2ReA)* -tRe_2m  - ((xM2ImA)*  tRe_2e ));
          out[(20+i)*2+1] = xM0ImA + ((xM2ReA)*  tRe_2e  + ((xM2ImA)* -tRe_2m )); 
          out[(21+i)*2+0] = xM1ReB + ((xM3ReB)* -tRe_2l  - ((xM3ImB)*  tRe_2f ));
          out[(21+i)*2+1] = xM1ImB + ((xM3ReB)*  tRe_2f  + ((xM3ImB)* -tRe_2l )); 
          out[(22+i)*2+0] = xM0ReC + ((xM2ReC)* -tRe_2k  - ((xM2ImC)*  tRe_2g ));
          out[(22+i)*2+1] = xM0ImC + ((xM2ReC)*  tRe_2g  + ((xM2ImC)* -tRe_2k )); 
          out[(23+i)*2+0] = xM1ReD + ((xM3ReD)* -tRe_2j  - ((xM3ImD)*  tRe_2h ));
          out[(23+i)*2+1] = xM1ImD + ((xM3ReD)*  tRe_2h  + ((xM3ImD)* -tRe_2j ));

          out[(52+i)*2+0] = xM0ReA - ((xM2ReA)* -tRe_2m  - ((xM2ImA)*  tRe_2e ));
          out[(52+i)*2+1] = xM0ImA - ((xM2ReA)*  tRe_2e  + ((xM2ImA)* -tRe_2m )); 
          out[(53+i)*2+0] = xM1ReB - ((xM3ReB)* -tRe_2l  - ((xM3ImB)*  tRe_2f ));
          out[(53+i)*2+1] = xM1ImB - ((xM3ReB)*  tRe_2f  + ((xM3ImB)* -tRe_2l )); 
          out[(54+i)*2+0] = xM0ReC - ((xM2ReC)* -tRe_2k  - ((xM2ImC)*  tRe_2g ));
          out[(54+i)*2+1] = xM0ImC - ((xM2ReC)*  tRe_2g  + ((xM2ImC)* -tRe_2k )); 
          out[(55+i)*2+0] = xM1ReD - ((xM3ReD)* -tRe_2j  - ((xM3ImD)*  tRe_2h ));
          out[(55+i)*2+1] = xM1ImD - ((xM3ReD)*  tRe_2h  + ((xM3ImD)* -tRe_2j )); 

          x0aRe_8 = out[(8+ i+ 0)*2+0]; //x0aIm = out[(8+ i+ 0)*2+1]; // 0
          x1aRe_8 = out[(8+ i+16)*2+0]; x1aIm_8 = out[(8+ i+16)*2+1];
          x2aRe_8 = out[(8+ i+32)*2+0]; x2aIm_8 = out[(8+ i+32)*2+1];
          x3aRe_8 = out[(8+ i+48)*2+0]; x3aIm_8 = out[(8+ i+48)*2+1];
          
          x0bRe_8 = x0dRe_0;            x0bIm_8 = -x0dIm_0;            
          x1bRe_8 = out[(8+ i+17)*2+0]; x1bIm_8 = out[(8+ i+17)*2+1];
          x2bRe_8 = out[(8+ i+33)*2+0]; x2bIm_8 = out[(8+ i+33)*2+1];
          x3bRe_8 = out[(8+ i+49)*2+0]; x3bIm_8 = out[(8+ i+49)*2+1];

          x0cRe_8 = x0cRe_0;            x0cIm_8 = -x0cIm_0;             
          x1cRe_8 = out[(8+ i+18)*2+0]; x1cIm_8 = out[(8+ i+18)*2+1];
          x2cRe_8 = out[(8+ i+34)*2+0]; x2cIm_8 = out[(8+ i+34)*2+1];
          x3cRe_8 = out[(8+ i+50)*2+0]; x3cIm_8 = out[(8+ i+50)*2+1];
          
          x0dRe_8 = x0bRe_0;            x0dIm_8 = -x0bIm_0;            
          x1dRe_8 = out[(8+ i+19)*2+0]; x1dIm_8 = out[(8+ i+19)*2+1];
          x2dRe_8 = out[(8+ i+35)*2+0]; x2dIm_8 = out[(8+ i+35)*2+1];
          x3dRe_8 = out[(8+ i+51)*2+0]; x3dIm_8 = out[(8+ i+51)*2+1];
          ...
          Tx2aIm =   x3aRe_8;
          /*
          Tx0aRe = (x1aRe * 0 - x1aIm * 1);
          Tx0aIm = (x1aRe * 1 + x1aIm * 0);
          Tx2aRe = (x3aRe * 0 - x3aIm * 1);
          Tx2aIm = (x3aRe * 1 + x3aIm * 0);
          */

          Tx1bRe = (x1bRe_8 * -tRe_1h - x1bIm_8 *  tRe_1b);
          Tx1bIm = (x1bRe_8 *  tRe_1b + x1bIm_8 * -tRe_1h);
          Tx3bRe = (x3bRe_8 * -tRe_1h - x3bIm_8 *  tRe_1b);
          Tx3bIm = (x3bRe_8 *  tRe_1b + x3bIm_8 * -tRe_1h);
          ...
          xM2ReC = x2cRe_8 + Tx2cRe;
          xM2ImC = x2cIm_8 + Tx2cIm; 

          xM1ReD = x0dRe_8 + Tx1dRe;
          xM1ImD = x0dIm_8 + Tx1dIm; 
          xM3ReD = x2dRe_8 + Tx3dRe;
          xM3ImD = x2dIm_8 + Tx3dIm; 

          out[( 8+i)*2+0] = xM0ReA + ((xM2ReA)*  tRe_2i - ((xM2ImA)*  tRe_2i));
          out[( 8+i)*2+1] = xM0ImA + ((xM2ReA)*  tRe_2i + ((xM2ImA)*  tRe_2i)); 
          out[( 9+i)*2+0] = xM1ReB + ((xM3ReB)*  tRe_2j - ((xM3ImB)*  tRe_2h));
          out[( 9+i)*2+1] = xM1ImB + ((xM3ReB)*  tRe_2h + ((xM3ImB)*  tRe_2j)); 
          out[(10+i)*2+0] = xM0ReC + ((xM2ReC)*  tRe_2k - ((xM2ImC)*  tRe_2g));
          out[(10+i)*2+1] = xM0ImC + ((xM2ReC)*  tRe_2g + ((xM2ImC)*  tRe_2k)); 
          out[(11+i)*2+0] = xM1ReD + ((xM3ReD)*  tRe_2l - ((xM3ImD)*  tRe_2f));
          out[(11+i)*2+1] = xM1ImD + ((xM3ReD)*  tRe_2f + ((xM3ImD)*  tRe_2l));

          out[(40+i)*2+0] = xM0ReA - ((xM2ReA)*  tRe_2i - ((xM2ImA)*  tRe_2i));
          out[(40+i)*2+1] = xM0ImA - ((xM2ReA)*  tRe_2i + ((xM2ImA)*  tRe_2i)); 
          out[(41+i)*2+0] = xM1ReB - ((xM3ReB)*  tRe_2j - ((xM3ImB)*  tRe_2h));
          out[(41+i)*2+1] = xM1ImB - ((xM3ReB)*  tRe_2h + ((xM3ImB)*  tRe_2j)); 
          out[(42+i)*2+0] = xM0ReC - ((xM2ReC)*  tRe_2k - ((xM2ImC)*  tRe_2g));
          out[(42+i)*2+1] = xM0ImC - ((xM2ReC)*  tRe_2g + ((xM2ImC)*  tRe_2k)); 
          out[(43+i)*2+0] = xM1ReD - ((xM3ReD)*  tRe_2l - ((xM3ImD)*  tRe_2f));
          out[(43+i)*2+1] = xM1ImD - ((xM3ReD)*  tRe_2f + ((xM3ImD)*  tRe_2l));  
          ...
          out[(24+i)*2+0] = xM0ReA + ((xM2ReA)* -tRe_2i  - ((xM2ImA)*  tRe_2i ));
          out[(24+i)*2+1] = xM0ImA + ((xM2ReA)*  tRe_2i  + ((xM2ImA)* -tRe_2i )); 
          out[(25+i)*2+0] = xM1ReB + ((xM3ReB)* -tRe_2h  - ((xM3ImB)*  tRe_2j ));
          out[(25+i)*2+1] = xM1ImB + ((xM3ReB)*  tRe_2j  + ((xM3ImB)* -tRe_2h )); 
          out[(26+i)*2+0] = xM0ReC + ((xM2ReC)* -tRe_2g  - ((xM2ImC)*  tRe_2k ));
          out[(26+i)*2+1] = xM0ImC + ((xM2ReC)*  tRe_2k  + ((xM2ImC)* -tRe_2g )); 
          out[(27+i)*2+0] = xM1ReD + ((xM3ReD)* -tRe_2f  - ((xM3ImD)*  tRe_2l ));
          out[(27+i)*2+1] = xM1ImD + ((xM3ReD)*  tRe_2l  + ((xM3ImD)* -tRe_2f ));

          out[(56+i)*2+0] = xM0ReA - ((xM2ReA)* -tRe_2i  - ((xM2ImA)*  tRe_2i ));
          out[(56+i)*2+1] = xM0ImA - ((xM2ReA)*  tRe_2i  + ((xM2ImA)* -tRe_2i )); 
          out[(57+i)*2+0] = xM1ReB - ((xM3ReB)* -tRe_2h  - ((xM3ImB)*  tRe_2j ));
          out[(57+i)*2+1] = xM1ImB - ((xM3ReB)*  tRe_2j  + ((xM3ImB)* -tRe_2h )); 
          out[(58+i)*2+0] = xM0ReC - ((xM2ReC)* -tRe_2g  - ((xM2ImC)*  tRe_2k ));
          out[(58+i)*2+1] = xM0ImC - ((xM2ReC)*  tRe_2k  + ((xM2ImC)* -tRe_2g )); 
          out[(59+i)*2+0] = xM1ReD - ((xM3ReD)* -tRe_2f  - ((xM3ImD)*  tRe_2l ));
          out[(59+i)*2+1] = xM1ImD - ((xM3ReD)*  tRe_2l  + ((xM3ImD)* -tRe_2f )); 

          x0aRe_12 = x0aRe_4;             x0aIm_12 = -x0aIm_4;              //x0aRe = out[(12+ i+ 0)*2+0]; x0aIm = out[(12+ i+ 0)*2+1];
          x1aRe_12 = out[(12+ i+16)*2+0]; x1aIm_12 = out[(12+ i+16)*2+1];
          x2aRe_12 = out[(12+ i+32)*2+0]; x2aIm_12 = out[(12+ i+32)*2+1];
          x3aRe_12 = out[(12+ i+48)*2+0]; x3aIm_12 = out[(12+ i+48)*2+1];
          
          x0bRe_12 = out[(12+ i+ 1)*2+0]; x0bIm_12 = out[(12+ i+ 1)*2+1];
          x1bRe_12 = out[(12+ i+17)*2+0]; x1bIm_12 = out[(12+ i+17)*2+1];
          x2bRe_12 = out[(12+ i+33)*2+0]; x2bIm_12 = out[(12+ i+33)*2+1];
          x3bRe_12 = out[(12+ i+49)*2+0]; x3bIm_12 = out[(12+ i+49)*2+1];
          
          x0cRe_12 = out[(12+ i+ 2)*2+0]; x0cIm_12 = out[(12+ i+ 2)*2+1];
          x1cRe_12 = out[(12+ i+18)*2+0]; x1cIm_12 = out[(12+ i+18)*2+1];
          x2cRe_12 = out[(12+ i+34)*2+0]; x2cIm_12 = out[(12+ i+34)*2+1];
          x3cRe_12 = out[(12+ i+50)*2+0]; x3cIm_12 = out[(12+ i+50)*2+1];
          
          x0dRe_12 = out[(12+ i+ 3)*2+0]; x0dIm_12 = out[(12+ i+ 3)*2+1];
          x1dRe_12 = out[(12+ i+19)*2+0]; x1dIm_12 = out[(12+ i+19)*2+1];
          x2dRe_12 = out[(12+ i+35)*2+0]; x2dIm_12 = out[(12+ i+35)*2+1];
          x3dRe_12 = out[(12+ i+51)*2+0]; x3dIm_12 = out[(12+ i+51)*2+1];

          Tx0aRe = (x1aRe_12 * -tRe_1e - x1aIm_12 *  tRe_1e);
          Tx0aIm = (x1aRe_12 *  tRe_1e + x1aIm_12 * -tRe_1e);
          Tx2aRe = (x3aRe_12 * -tRe_1e - x3aIm_12 *  tRe_1e);
          Tx2aIm = (x3aRe_12 *  tRe_1e + x3aIm_12 * -tRe_1e);

          Tx1bRe = (x1bRe_12 * -tRe_1d - x1bIm_12 *  tRe_1f);
          Tx1bIm = (x1bRe_12 *  tRe_1f + x1bIm_12 * -tRe_1d);
          Tx3bRe = (x3bRe_12 * -tRe_1d - x3bIm_12 *  tRe_1f);
          Tx3bIm = (x3bRe_12 *  tRe_1f + x3bIm_12 * -tRe_1d);

          Tx0cRe = (x1cRe_12 * -tRe_1c - x1cIm_12 *  tRe_1g);
          Tx0cIm = (x1cRe_12 *  tRe_1g + x1cIm_12 * -tRe_1c);
          Tx2cRe = (x3cRe_12 * -tRe_1c - x3cIm_12 *  tRe_1g);
          Tx2cIm = (x3cRe_12 *  tRe_1g + x3cIm_12 * -tRe_1c);

          Tx1dRe = (x1dRe_12 * -tRe_1b - x1dIm_12 *  tRe_1h);
          Tx1dIm = (x1dRe_12 *  tRe_1h + x1dIm_12 * -tRe_1b);
          Tx3dRe = (x3dRe_12 * -tRe_1b - x3dIm_12 *  tRe_1h);
          Tx3dIm = (x3dRe_12 *  tRe_1h + x3dIm_12 * -tRe_1b);
          ...
          xM1ReB = x0bRe_12 + Tx1bRe;
          xM1ImB = x0bIm_12 + Tx1bIm;  
          xM3ReB = x2bRe_12 + Tx3bRe;
          xM3ImB = x2bIm_12 + Tx3bIm; 
          ...
          out[(12+i)*2+0] = xM0ReA + ((xM2ReA)*  tRe_2m - ((xM2ImA)*  tRe_2e));
          out[(12+i)*2+1] = xM0ImA + ((xM2ReA)*  tRe_2e + ((xM2ImA)*  tRe_2m)); 
          out[(13+i)*2+0] = xM1ReB + ((xM3ReB)*  tRe_2n - ((xM3ImB)*  tRe_2d));
          out[(13+i)*2+1] = xM1ImB + ((xM3ReB)*  tRe_2d + ((xM3ImB)*  tRe_2n)); 
          out[(14+i)*2+0] = xM0ReC + ((xM2ReC)*  tRe_2o - ((xM2ImC)*  tRe_2c));
          out[(14+i)*2+1] = xM0ImC + ((xM2ReC)*  tRe_2c + ((xM2ImC)*  tRe_2o)); 
          out[(15+i)*2+0] = xM1ReD + ((xM3ReD)*  tRe_2p - ((xM3ImD)*  tRe_2b));
          out[(15+i)*2+1] = xM1ImD + ((xM3ReD)*  tRe_2b + ((xM3ImD)*  tRe_2p));

          out[(44+i)*2+0] = xM0ReA - ((xM2ReA)*  tRe_2m - ((xM2ImA)*  tRe_2e));
          out[(44+i)*2+1] = xM0ImA - ((xM2ReA)*  tRe_2e + ((xM2ImA)*  tRe_2m)); 
          out[(45+i)*2+0] = xM1ReB - ((xM3ReB)*  tRe_2n - ((xM3ImB)*  tRe_2d));
          out[(45+i)*2+1] = xM1ImB - ((xM3ReB)*  tRe_2d + ((xM3ImB)*  tRe_2n)); 
          out[(46+i)*2+0] = xM0ReC - ((xM2ReC)*  tRe_2o - ((xM2ImC)*  tRe_2c));
          out[(46+i)*2+1] = xM0ImC - ((xM2ReC)*  tRe_2c + ((xM2ImC)*  tRe_2o)); 
          out[(47+i)*2+0] = xM1ReD - ((xM3ReD)*  tRe_2p - ((xM3ImD)*  tRe_2b));
          out[(47+i)*2+1] = xM1ImD - ((xM3ReD)*  tRe_2b + ((xM3ImD)*  tRe_2p)); 
          ...
          xM1ReB = x0bRe_12 - Tx1bRe; // x0bRe - (x1bRe * -tRe_1d - x1bIm *  tRe_1f)
          xM1ImB = x0bIm_12 - Tx1bIm; // x0bIm - (x1bIm * -tRe_1d + x1bRe *  tRe_1f)
          xM3ReB = x2bRe_12 - Tx3bRe; // x2bRe - (x3bRe * -tRe_1d - x3bIm *  tRe_1f)
          xM3ImB = x2bIm_12 - Tx3bIm; // x2bIm - (x3bIm * -tRe_1d + x3bRe *  tRe_1f)
          ...
          xM1ReD = x0dRe_12 - Tx1dRe; // x0dRe - (x1dRe * -tRe_1b - x1dIm *  tRe_1h)
          xM1ImD = x0dIm_12 - Tx1dIm; // x0dIm - (x1dIm * -tRe_1b + x1dRe *  tRe_1h) 
          xM3ReD = x2dRe_12 - Tx3dRe; // x2dRe - (x3dRe * -tRe_1b - x3dIm *  tRe_1h)
          xM3ImD = x2dIm_12 - Tx3dIm; // x2dIm - (x3dIm * -tRe_1b + x3dRe *  tRe_1h)
          ...
          //out[( 1+i)*2+0] = xM1ReB + ((xM3ReB)*  tRe_2b - ((xM3ImB)*  tRe_2p)); // x0bRe   +   x1bRe*tRe_1d   +   x1bIm*tRe_1f  + (x2bRe*tRe_2b + x3bRe*tRe_1d*tRe_2b + x3bIm*tRe_1f*tRe_2b)    - x2bIm*tRe_2p - x3bIm*tRe_1d*tRe_2p + x3bRe*tRe_1f*tRe_2p
          //out[( 1+i)*2+1] = xM1ImB + ((xM3ReB)*  tRe_2p + ((xM3ImB)*  tRe_2b)); // 
          out[(31+i)*2+0] = xM1ReD + ((xM3ReD)* -tRe_2b  - ((xM3ImD)*  tRe_2p )); // x0dRe   +   x1dRe*tRe_1b   +   x1dIm*tRe_1h  - (x2bRe*tRe_2b + x3bRe*tRe_1d*tRe_2b + x3bIm*tRe_1f*tRe_2b)    - x2bIm*tRe_2p - x3bIm*tRe_1d*tRe_2p + x3bRe*tRe_1f*tRe_2p
          out[(31+i)*2+1] = xM1ImD + ((xM3ReD)*  tRe_2p  + ((xM3ImD)* -tRe_2b )); //

          out[(60+i)*2+0] = xM0ReA - ((xM2ReA)* -tRe_2e  - ((xM2ImA)*  tRe_2m ));
          out[(60+i)*2+1] = xM0ImA - ((xM2ReA)*  tRe_2m  + ((xM2ImA)* -tRe_2e )); 
          out[(61+i)*2+0] = xM1ReB - ((xM3ReB)* -tRe_2d  - ((xM3ImB)*  tRe_2n ));
          out[(61+i)*2+1] = xM1ImB - ((xM3ReB)*  tRe_2n  + ((xM3ImB)* -tRe_2d )); 
          out[(62+i)*2+0] = xM0ReC - ((xM2ReC)* -tRe_2c  - ((xM2ImC)*  tRe_2o ));
          out[(62+i)*2+1] = xM0ImC - ((xM2ReC)*  tRe_2o  + ((xM2ImC)* -tRe_2c )); 
          out[(63+i)*2+0] = xM1ReD - ((xM3ReD)* -tRe_2b  - ((xM3ImD)*  tRe_2p ));
          out[(63+i)*2+1] = xM1ImD - ((xM3ReD)*  tRe_2p  + ((xM3ImD)* -tRe_2b )); 
    }
