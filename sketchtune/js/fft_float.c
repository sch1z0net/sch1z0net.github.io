...
/*
    ...
    for(int idx = 0; idx < 2048; idx+=128){
        ...
        float T0x1bRe = (x1bRe_0 * t2Re_1b - x1bIm_0 * t2Re_1p);
        float T0x1bIm = (x1bRe_0 * t2Re_1p + x1bIm_0 * t2Re_1b);
        float T0x3bRe = (x3bRe_0 * t2Re_1b - x3bIm_0 * t2Re_1p);
        float T0x3bIm = (x3bRe_0 * t2Re_1p + x3bIm_0 * t2Re_1b);
        
        float T0x0cRe = (x1cRe_0 * t2Re_1c - x1cIm_0 * t2Re_1o);
        float T0x0cIm = (x1cRe_0 * t2Re_1o + x1cIm_0 * t2Re_1c);
        float T0x2cRe = (x3cRe_0 * t2Re_1c - x3cIm_0 * t2Re_1o);
        float T0x2cIm = (x3cRe_0 * t2Re_1o + x3cIm_0 * t2Re_1c);
        
        float T0x1dRe = (x1dRe_0 * t2Re_1d - x1dIm_0 * t2Re_1n);
        float T0x1dIm = (x1dRe_0 * t2Re_1n + x1dIm_0 * t2Re_1d);
        float T0x3dRe = (x3dRe_0 * t2Re_1d - x3dIm_0 * t2Re_1n);
        float T0x3dIm = (x3dRe_0 * t2Re_1n + x3dIm_0 * t2Re_1d);

        float T0x0eRe = (x1eRe_0 * t2Re_1e - x1eIm_0 * t2Re_1m);
        float T0x0eIm = (x1eRe_0 * t2Re_1m + x1eIm_0 * t2Re_1e);
        float T0x2eRe = (x3eRe_0 * t2Re_1e - x3eIm_0 * t2Re_1m);
        float T0x2eIm = (x3eRe_0 * t2Re_1m + x3eIm_0 * t2Re_1e);

        float T0x1fRe = (x1fRe_0 * t2Re_1f - x1fIm_0 * t2Re_1l);
        float T0x1fIm = (x1fRe_0 * t2Re_1l + x1fIm_0 * t2Re_1f);
        float T0x3fRe = (x3fRe_0 * t2Re_1f - x3fIm_0 * t2Re_1l);
        float T0x3fIm = (x3fRe_0 * t2Re_1l + x3fIm_0 * t2Re_1f);

        float T0x0gRe = (x1gRe_0 * t2Re_1g - x1gIm_0 * t2Re_1k);
        float T0x0gIm = (x1gRe_0 * t2Re_1k + x1gIm_0 * t2Re_1g);
        float T0x2gRe = (x3gRe_0 * t2Re_1g - x3gIm_0 * t2Re_1k);
        float T0x2gIm = (x3gRe_0 * t2Re_1k + x3gIm_0 * t2Re_1g);

        float T0x1hRe = (x1hRe_0 * t2Re_1h - x1hIm_0 * t2Re_1j);
        float T0x1hIm = (x1hRe_0 * t2Re_1j + x1hIm_0 * t2Re_1h);
        float T0x3hRe = (x3hRe_0 * t2Re_1h - x3hIm_0 * t2Re_1j);
        float T0x3hIm = (x3hRe_0 * t2Re_1j + x3hIm_0 * t2Re_1h);
        ...
        float res0ReB = x0bRe_0 + T0x1bRe + ((x2bRe_0 + T0x3bRe)*  t2Re_2af - ((x2bIm_0 + T0x3bIm)*  t2Re_2b));
        out1024[idx  +   2] =   res0ReB;
        out1024[idx  + 126] =   res0ReB; 
        float res0ImB = x0bIm_0 + T0x1bIm + ((x2bRe_0 + T0x3bRe)*  t2Re_2b + ((x2bIm_0 + T0x3bIm)*  t2Re_2af)); 
        out1024[idx  + 127] = - res0ImB;
        out1024[idx  +   3] =   res0ImB;
        float res0ReC = x0cRe_0 + T0x0cRe + ((x2cRe_0 + T0x2cRe)*  t2Re_2ae - ((x2cIm_0 + T0x2cIm)*  t2Re_2c));  
        out1024[idx  +   4] =   res0ReC;
        out1024[idx  + 124] =   res0ReC;
        float res0ImC = x0cIm_0 + T0x0cIm + ((x2cRe_0 + T0x2cRe)*  t2Re_2d + ((x2cIm_0 + T0x2cIm)*  t2Re_2ae));
        out1024[idx  + 125] = - res0ImC;
        out1024[idx  +   5] =   res0ImC; 
        float res0ReD = x0dRe_0 + T0x1dRe + ((x2dRe_0 + T0x3dRe)*  t2Re_2ad - ((x2dIm_0 + T0x3dIm)*  t2Re_2d));  
        out1024[idx  +   6] =   res0ReD;
        out1024[idx  + 122] =   res0ReD;
        float res0ImD = x0dIm_0 + T0x1dIm + ((x2dRe_0 + T0x3dRe)*  t2Re_2d + ((x2dIm_0 + T0x3dIm)*  t2Re_2ad)); 
        out1024[idx  + 123] = - res0ImD;
        out1024[idx  +   7] =   res0ImD;  

        float res0ReE = x0eRe_0 + T0x1eRe + ((x2eRe_0 + T0x3eRe)*  t2Re_2ac - ((x2eIm_0 + T0x3eIm)*  t2Re_2e));
        out1024[idx  + ] =   res0ReE;
        out1024[idx  + ] =   res0ReE; 
        float res0ImE = x0eIm_0 + T0x1eIm + ((x2eRe_0 + T0x3eRe)*  t2Re_2e + ((x2eIm_0 + T0x3eIm)*  t2Re_2ac)); 
        out1024[idx  + ] = - res0ImE;
        out1024[idx  + ] =   res0ImE;
        float res0ReF = x0fRe_0 + T0x1fRe + ((x2fRe_0 + T0x3fRe)*  t2Re_2ab - ((x2fIm_0 + T0x3fIm)*  t2Re_2f));
        out1024[idx  + ] =   res0ReF;
        out1024[idx  + ] =   res0ReF; 
        float res0ImF = x0fIm_0 + T0x1fIm + ((x2fRe_0 + T0x3fRe)*  t2Re_2f + ((x2fIm_0 + T0x3fIm)*  t2Re_2ab)); 
        out1024[idx  + ] = - res0ImF;
        out1024[idx  + ] =   res0ImF;
        float res0ReG = x0gRe_0 + T0x0gRe + ((x2gRe_0 + T0x2gRe)*  t2Re_2aa - ((x2gIm_0 + T0x2gIm)*  t2Re_2g));  
        out1024[idx  + ] =   res0ReG;
        out1024[idx  + ] =   res0ReG;
        float res0ImG = x0gIm_0 + T0x0gIm + ((x2gRe_0 + T0x2gRe)*  t2Re_2g + ((x2gIm_0 + T0x2gIm)*  t2Re_2aa));
        out1024[idx  + ] = - res0ImG;
        out1024[idx  + ] =   res0ImG; 
        float res0ReH = x0hRe_0 + T0x1hRe + ((x2hRe_0 + T0x3hRe)*  t2Re_2z - ((x2hIm_0 + T0x3hIm)*  t2Re_2h));  
        out1024[idx  + ] =   res0ReH;
        out1024[idx  + ] =   res0ReH;
        float res0ImH = x0hIm_0 + T0x1hIm + ((x2hRe_0 + T0x3hRe)*  t2Re_2h + ((x2hIm_0 + T0x3hIm)*  t2Re_2z)); 
        out1024[idx  + ] = - res0ImH;
        out1024[idx  + ] =   res0ImH;  

        float res0ReI = x0eRe_0 + T0x1eRe + ((x2eRe_0 + T0x3eRe)*  t2Re_2ac - ((x2eIm_0 + T0x3eIm)*  t2Re_2e));
        out1024[idx  + ] =   res0ReI;
        out1024[idx  + ] =   res0ReI; 
        float res0ImI = x0eIm_0 + T0x1eIm + ((x2eRe_0 + T0x3eRe)*  t2Re_2e + ((x2eIm_0 + T0x3eIm)*  t2Re_2ac)); 
        out1024[idx  + ] = - res0ImI;
        out1024[idx  + ] =   res0ImI;
        float res0ReJ = x0fRe_0 + T0x1fRe + ((x2fRe_0 + T0x3fRe)*  t2Re_2ab - ((x2fIm_0 + T0x3fIm)*  t2Re_2f));
        out1024[idx  + ] =   res0ReJ;
        out1024[idx  + ] =   res0ReJ; 
        float res0ImJ = x0fIm_0 + T0x1fIm + ((x2fRe_0 + T0x3fRe)*  t2Re_2f + ((x2fIm_0 + T0x3fIm)*  t2Re_2ab)); 
        out1024[idx  + ] = - res0ImJ;
        out1024[idx  + ] =   res0ImJ;
        float res0ReG = x0gRe_0 + T0x0gRe + ((x2gRe_0 + T0x2gRe)*  t2Re_2aa - ((x2gIm_0 + T0x2gIm)*  t2Re_2g));  
        out1024[idx  + ] =   res0ReG;
        ...
        out1024[idx  +  97] = - res1ImA;
        out1024[idx  +  33] =   res1ImA;
        float res1ReB = x0bRe_0 - T0x1bRe + ((x2bRe_0 - T0x3bRe)* -t2Re_2af  - ((x2bIm_0 - T0x3bIm)*  t2Re_2b ));
        out1024[idx  +  34] =   res1ReB;
        out1024[idx  +  94] =   res1ReB;
        float res1ImB = x0bIm_0 - T0x1bIm + ((x2bRe_0 - T0x3bRe)*  t2Re_2b  + ((x2bIm_0 - T0x3bIm)* -t2Re_2af )); 
        out1024[idx  +  95] = - res1ImB; 
        out1024[idx  +  35] =   res1ImB;
        float res1ReC = x0cRe_0 - T0x0cRe + ((x2cRe_0 - T0x2cRe)* -t2Re_2ae  - ((x2cIm_0 - T0x2cIm)*  t2Re_2c )); 
        out1024[idx  +  36] =   res1ReC;
        out1024[idx  +  92] =   res1ReC;
        float res1ImC = x0cIm_0 - T0x0cIm + ((x2cRe_0 - T0x2cRe)*  t2Re_2c  + ((x2cIm_0 - T0x2cIm)* -t2Re_2ae ));
        out1024[idx  +  93] = - res1ImC;  
        out1024[idx  +  37] =   res1ImC; 
        float res1ReD = x0dRe_0 - T0x1dRe + ((x2dRe_0 - T0x3dRe)* -t2Re_2ad  - ((x2dIm_0 - T0x3dIm)*  t2Re_2d ));
        out1024[idx  +  38] =   res1ReD;
        out1024[idx  +  90] =   res1ReD;
        float res1ImD = x0dIm_0 - T0x1dIm + ((x2dRe_0 - T0x3dRe)*  t2Re_2d  + ((x2dIm_0 - T0x3dIm)* -t2Re_2ad ));  
        out1024[idx  +  91] = - res1ImD; 
        out1024[idx  +  39] =   res1ImD;

        float res1ReE = x0cRe_0 - T0x0eRe + ((x2eRe_0 - T0x2eRe)* -t2Re_2ac  - ((x2eIm_0 - T0x2eIm)*  t2Re_2e )); 
        out1024[idx  + ] =   res1ReE;
        out1024[idx  + ] =   res1ReE;
        float res1ImE = x0cIm_0 - T0x0eIm + ((x2eRe_0 - T0x2eRe)*  t2Re_2e  + ((x2eIm_0 - T0x2eIm)* -t2Re_2ac ));
        out1024[idx  + ] = - res1ImE;  
        out1024[idx  + ] =   res1ImE; 
        float res1ReF = x0dRe_0 - T0x1fRe + ((x2fRe_0 - T0x3fRe)* -t2Re_2ab  - ((x2fIm_0 - T0x3fIm)*  t2Re_2f ));
        out1024[idx  + ] =   res1ReF;
        out1024[idx  + ] =   res1ReF;
        float res1ImF = x0dIm_0 - T0x1fIm + ((x2fRe_0 - T0x3fRe)*  t2Re_2f  + ((x2fIm_0 - T0x3fIm)* -t2Re_2ab ));  
        out1024[idx  + ] = - res1ImF; 
        out1024[idx  + ] =   res1ImF;
        float res1ReG = x0cRe_0 - T0x0gRe + ((x2gRe_0 - T0x2gRe)* -t2Re_2aa  - ((x2gIm_0 - T0x2gIm)*  t2Re_2g )); 
        out1024[idx  + ] =   res1ReG;
        out1024[idx  + ] =   res1ReG;
        float res1ImG = x0cIm_0 - T0x0gIm + ((x2gRe_0 - T0x2gRe)*  t2Re_2g  + ((x2gIm_0 - T0x2gIm)* -t2Re_2aa ));
        out1024[idx  + ] = - res1ImG;  
        out1024[idx  + ] =   res1ImG; 
        float res1ReH = x0dRe_0 - T0x1hRe + ((x2hRe_0 - T0x3hRe)* -t2Re_2z  - ((x2hIm_0 - T0x3hIm)*  t2Re_2h ));
        out1024[idx  + ] =   res1ReH;
        out1024[idx  + ] =   res1ReH;
        float res1ImH = x0dIm_0 - T0x1hIm + ((x2hRe_0 - T0x3hRe)*  t2Re_2h  + ((x2hIm_0 - T0x3hIm)* -t2Re_2z ));  
        out1024[idx  + ] = - res1ImH; 
        out1024[idx  + ] =   res1ImH;



        float T1x0aRe = (x1aRe_4 * t2Re_1i - x1aIm_4 * t2Re_1i);
        float T1x0aIm = (x1aRe_4 * t2Re_1i + x1aIm_4 * t2Re_1i);
        float T1x2aRe = (x3aRe_4 * t2Re_1i - x3aIm_4 * t2Re_1i);
        float T1x2aIm = (x3aRe_4 * t2Re_1i + x3aIm_4 * t2Re_1i);

        float T1x1bRe = (x1bRe_4 * t2Re_1j - x1bIm_4 * t2Re_1h);
        float T1x1bIm = (x1bRe_4 * t2Re_1h + x1bIm_4 * t2Re_1j);
        float T1x3bRe = (x3bRe_4 * t2Re_1j - x3bIm_4 * t2Re_1h);
        float T1x3bIm = (x3bRe_4 * t2Re_1h + x3bIm_4 * t2Re_1j);

        float T1x0cRe = (x1cRe_4 * t2Re_1k - x1cIm_4 * t2Re_1g);
        float T1x0cIm = (x1cRe_4 * t2Re_1g + x1cIm_4 * t2Re_1k);
        float T1x2cRe = (x3cRe_4 * t2Re_1k - x3cIm_4 * t2Re_1g);
        float T1x2cIm = (x3cRe_4 * t2Re_1g + x3cIm_4 * t2Re_1k);

        float T1x1dRe = (x1dRe_4 * t2Re_1l - x1dIm_4 * t2Re_1f);
        float T1x1dIm = (x1dRe_4 * t2Re_1f + x1dIm_4 * t2Re_1l);
        float T1x3dRe = (x3dRe_4 * t2Re_1l - x3dIm_4 * t2Re_1f);
        float T1x3dIm = (x3dRe_4 * t2Re_1f + x3dIm_4 * t2Re_1l);

        float T1x0eRe = (x1eRe_4 * t2Re_1m - x1eIm_4 * t2Re_1e);
        float T1x0eIm = (x1eRe_4 * t2Re_1e + x1eIm_4 * t2Re_1m);
        float T1x2eRe = (x3eRe_4 * t2Re_1m - x3eIm_4 * t2Re_1e);
        float T1x2eIm = (x3eRe_4 * t2Re_1e + x3eIm_4 * t2Re_1m);

        float T1x1fRe = (x1fRe_4 * t2Re_1n - x1fIm_4 * t2Re_1d);
        float T1x1fIm = (x1fRe_4 * t2Re_1d + x1fIm_4 * t2Re_1n);
        float T1x3fRe = (x3fRe_4 * t2Re_1n - x3fIm_4 * t2Re_1d);
        float T1x3fIm = (x3fRe_4 * t2Re_1d + x3fIm_4 * t2Re_1n);

        float T1x0gRe = (x1gRe_4 * t2Re_1o - x1gIm_4 * t2Re_1c);
        float T1x0gIm = (x1gRe_4 * t2Re_1c + x1gIm_4 * t2Re_1o);
        float T1x2gRe = (x3gRe_4 * t2Re_1o - x3gIm_4 * t2Re_1c);
        float T1x2gIm = (x3gRe_4 * t2Re_1c + x3gIm_4 * t2Re_1o);

        float T1x1hRe = (x1hRe_4 * t2Re_1p - x1hIm_4 * t2Re_1b);
        float T1x1hIm = (x1hRe_4 * t2Re_1b + x1hIm_4 * t2Re_1p);
        float T1x3hRe = (x3hRe_4 * t2Re_1p - x3hIm_4 * t2Re_1b);
        float T1x3hIm = (x3hRe_4 * t2Re_1b + x3hIm_4 * t2Re_1p);




        float res2ReA =  x0aRe_4 + T1x0aRe + ((x2aRe_4 + T1x2aRe)* t2Re_2y  - (( x2aIm_4 + T1x2aIm)*  t2Re_2i ));
        out1024[idx  +  56] =   res2ReA;
        out1024[idx  +  72] =   res2ReA;
        float res2ImA =  x0aIm_4 + T1x0aIm + ((x2aRe_4 + T1x2aRe)* t2Re_2i  + (( x2aIm_4 + T1x2aIm)*  t2Re_2y ));
        out1024[idx  +  73] = - res2ImA;
        out1024[idx  +  57] =   res2ImA;
        float res2ReB =  x0hRe_4 + T1x1bRe + ((x2hRe_4 + T1x3bRe)* t2Re_2x  - (( x2hIm_4 + T1x3bIm)*  t2Re_2j ));
        out1024[idx  +  58] =   res2ReB;
        out1024[idx  +  70] =   res2ReB;
        float res2ImB =  x0hIm_4 + T1x1bIm + ((x2hRe_4 + T1x3bRe)* t2Re_2j  + (( x2hIm_4 + T1x3bIm)*  t2Re_2x ));
        out1024[idx  +  71] = - res2ImB; 
        out1024[idx  +  59] =   res2ImB;
        float res2ReC =  x0gRe_4 + T1x0cRe + ((x2gRe_4 + T1x2cRe)* t2Re_2w  - (( x2gIm_4 + T1x2cIm)*  t2Re_2k ));
        out1024[idx  +  60] =   res2ReC;
        out1024[idx  +  68] =   res2ReC;
        float res2ImC =  x0gIm_4 + T1x0cIm + ((x2gRe_4 + T1x2cRe)* t2Re_2k  + (( x2gIm_4 + T1x2cIm)*  t2Re_2w ));
        out1024[idx  +  69] = - res2ImC;
        out1024[idx  +  61] =   res2ImC;
        float res2ReD =  x0fRe_4 + T1x1dRe + ((x2fRe_4 + T1x3dRe)* t2Re_2v  - (( x2fIm_4 + T1x3dIm)*  t2Re_2l ));
        out1024[idx  +  62] =   res2ReD;
        out1024[idx  +  66] =   res2ReD;
        float res2ImD =  x0fIm_4 + T1x1dIm + ((x2fRe_4 + T1x3dRe)* t2Re_2l  + (( x2fIm_4 + T1x3dIm)*  t2Re_2v ));
        out1024[idx  +  67] = - res2ImD;
        out1024[idx  +  63] =   res2ImD;

        float res2ReE =  x0eRe_4 + T1x0eRe + ((x2eRe_4 + T1x2eRe)* t2Re_2u  - (( x2eIm_4 + T1x2eIm)*  t2Re_2m ));
        out1024[idx  +  ] =   res2ReE;
        out1024[idx  +  ] =   res2ReE;
        float res2ImE =  x0eIm_4 + T1x0eIm + ((x2eRe_4 + T1x2eRe)* t2Re_2m  + (( x2eIm_4 + T1x2eIm)*  t2Re_2u ));
        out1024[idx  +  ] = - res2ImE;
        out1024[idx  +  ] =   res2ImE;
        float res2ReF =  x0dRe_4 + T1x1fRe + ((x2dRe_4 + T1x3fRe)* t2Re_2t  - (( x2dIm_4 + T1x3fIm)*  t2Re_2n ));
        out1024[idx  +  ] =   res2ReF;
        out1024[idx  +  ] =   res2ReF;
        float res2ImF =  x0dIm_4 + T1x1fIm + ((x2dRe_4 + T1x3fRe)* t2Re_2n  + (( x2dIm_4 + T1x3fIm)*  t2Re_2t ));
        out1024[idx  +  ] = - res2ImF; 
        out1024[idx  +  ] =   res2ImF;
        float res2ReG =  x0cRe_4 + T1x0gRe + ((x2cRe_4 + T1x2gRe)* t2Re_2s  - (( x2cIm_4 + T1x2gIm)*  t2Re_2o ));
        out1024[idx  +  ] =   res2ReG;
        out1024[idx  +  ] =   res2ReG;
        float res2ImG =  x0cIm_4 + T1x0gIm + ((x2cRe_4 + T1x2gRe)* t2Re_2o  + (( x2cIm_4 + T1x2gIm)*  t2Re_2s ));
        out1024[idx  +  ] = - res2ImG;
        out1024[idx  +  ] =   res2ImG;
        float res2ReH =  x0bRe_4 + T1x1hRe + ((x2bRe_4 + T1x3hRe)* t2Re_2r  - (( x2bIm_4 + T1x3hIm)*  t2Re_2p ));
        out1024[idx  +  ] =   res2ReH;
        out1024[idx  +  ] =   res2ReH;
        float res2ImH =  x0bIm_4 + T1x1hIm + ((x2bRe_4 + T1x3hRe)* t2Re_2p  + (( x2bIm_4 + T1x3hIm)*  t2Re_2r ));
        out1024[idx  +  ] = - res2ImH;
        out1024[idx  +  ] =   res2ImH;
        ...
        float res3ReA =  x0aRe_4 - T1x0aRe + ((x2aRe_8 - T1x2aRe)* -t2Re_2y  - ((-x2aIm_4 - T1x2aIm)*  t2Re_2i ));
        out1024[idx  +  56] =   res3ReA;
        out1024[idx  +  72] =   res3ReA;
        float res3ImA =  x0aIm_4 - T1x0aIm + ((x2aRe_8 - T1x2aRe)*  t2Re_2i  + ((-x2aIm_4 - T1x2aIm)* -t2Re_2y ));
        out1024[idx  +  73] = - res3ImA;
        out1024[idx  +  57] =   res3ImA;
        float res3ReB =  x0hRe_4 - T1x1bRe + ((x2hRe_4 - T1x3bRe)* -t2Re_2x  - ((-x2hIm_4 - T1x3bIm)*  t2Re_2j ));
        out1024[idx  +  58] =   res3ReB;
        out1024[idx  +  70] =   res3ReB;
        float res3ImB =  x0hIm_4 - T1x1bIm + ((x2hRe_4 - T1x3bRe)*  t2Re_2j  + ((-x2hIm_4 - T1x3bIm)* -t2Re_2x ));
        out1024[idx  +  71] = - res3ImB; 
        out1024[idx  +  59] =   res3ImB;
        float res3ReC =  x0gRe_4 - T1x0cRe + ((x2gRe_4 - T1x2cRe)* -t2Re_2w  - ((-x2gIm_4 - T1x2cIm)*  t2Re_2k ));
        out1024[idx  +  60] =   res3ReC;
        out1024[idx  +  68] =   res3ReC;
        float res3ImC =  x0gIm_4 - T1x0cIm + ((x2gRe_4 - T1x2cRe)*  t2Re_2k  + ((-x2gIm_4 - T1x2cIm)* -t2Re_2w ));
        out1024[idx  +  69] = - res3ImC;
        out1024[idx  +  61] =   res3ImC;
        float res3ReD =  x0fRe_4 - T1x1dRe + ((x2fRe_4 - T1x3dRe)* -t2Re_2v  - ((-x2fIm_4 - T1x3dIm)*  t2Re_2l ));
        out1024[idx  +  62] =   res3ReD;
        out1024[idx  +  66] =   res3ReD;
        float res3ImD =  x0fIm_4 - T1x1dIm + ((x2fRe_4 - T1x3dRe)*  t2Re_2l  + ((-x2fIm_4 - T1x3dIm)* -t2Re_2v ));
        out1024[idx  +  67] = - res3ImD;
        out1024[idx  +  63] =   res3ImD;

        float res3ReE =  x0eRe_4 - T1x0eRe + ((x2eRe_4 - T1x2eRe)* -t2Re_2u  - ((-x2eIm_4 - T1x2eIm)*  t2Re_2m ));
        out1024[idx  +  ] =   res3ReE;
        out1024[idx  +  ] =   res3ReE;
        float res3ImE =  x0eIm_4 - T1x0eIm + ((x2eRe_4 - T1x2eRe)*  t2Re_2m  + ((-x2eIm_4 - T1x2eIm)* -t2Re_2u ));
        out1024[idx  +  ] = - res3ImE;
        out1024[idx  +  ] =   res3ImE;
        float res3ReF =  x0dRe_4 - T1x1fRe + ((x2dRe_4 - T1x3fRe)* -t2Re_2t  - ((-x2dIm_4 - T1x3fIm)*  t2Re_2n ));
        out1024[idx  +  ] =   res3ReF;
        out1024[idx  +  ] =   res3ReF;
        float res3ImF =  x0dIm_4 - T1x1fIm + ((x2dRe_4 - T1x3fRe)*  t2Re_2n  + ((-x2dIm_4 - T1x3fIm)* -t2Re_2t ));
        out1024[idx  +  ] = - res3ImF; 
        out1024[idx  +  ] =   res3ImF;
        float res3ReG =  x0cRe_4 - T1x0gRe + ((x2cRe_4 - T1x2gRe)* -t2Re_2s  - ((-x2cIm_4 - T1x2gIm)*  t2Re_2o ));
        out1024[idx  +  ] =   res3ReG;
        out1024[idx  +  ] =   res3ReG;
        float res3ImG =  x0cIm_4 - T1x0gIm + ((x2cRe_4 - T1x2gRe)*  t2Re_2o  + ((-x2cIm_4 - T1x2gIm)* -t2Re_2s ));
        out1024[idx  +  ] = - res3ImG;
        out1024[idx  +  ] =   res3ImG;
        float res3ReH =  x0bRe_4 - T1x1hRe + ((x2bRe_4 - T1x3hRe)* -t2Re_2r  - ((-x2bIm_4 - T1x3hIm)*  t2Re_2p ));
        out1024[idx  +  ] =   res3ReH;
        out1024[idx  +  ] =   res3ReH;
        float res3ImH =  x0bIm_4 - T1x1hIm + ((x2bRe_4 - T1x3hRe)*  t2Re_2p  + ((-x2bIm_4 - T1x3hIm)* -t2Re_2r ));
        out1024[idx  +  ] = - res3ImH;
        out1024[idx  +  ] =   res3ImH;
        ...
        float T2x1bRe = (x1hRe_4 * -t2Re_1p - -x1hIm_4 *  t2Re_1b);
        float T2x1bIm = (x1hRe_4 *  t2Re_1b + -x1hIm_4 * -t2Re_1p);
        float T2x3bRe = (x3hRe_4 * -t2Re_1p - -x3hIm_4 *  t2Re_1b);
        float T2x3bIm = (x3hRe_4 *  t2Re_1b + -x3hIm_4 * -t2Re_1p);

        float T2x0cRe = (x1gRe_4 * -t2Re_1o - -x1gIm_4 *  t2Re_1c);
        float T2x0cIm = (x1gRe_4 *  t2Re_1c + -x1gIm_4 * -t2Re_1o);
        float T2x2cRe = (x3gRe_4 * -t2Re_1o - -x3gIm_4 *  t2Re_1c);
        float T2x2cIm = (x3gRe_4 *  t2Re_1c + -x3gIm_4 * -t2Re_1o);

        float T2x1dRe = (x1fRe_4 * -t2Re_1n - -x1fIm_4 *  t2Re_1d);
        float T2x1dIm = (x1fRe_4 *  t2Re_1d + -x1fIm_4 * -t2Re_1n);
        float T2x3dRe = (x3fRe_4 * -t2Re_1n - -x3fIm_4 *  t2Re_1d);
        float T2x3dIm = (x3fRe_4 *  t2Re_1d + -x3fIm_4 * -t2Re_1n);


        float T2x0eRe = (x1eRe_4 * -t2Re_1m - -x1eIm_4 *  t2Re_1e);
        float T2x0eIm = (x1eRe_4 *  t2Re_1e + -x1eIm_4 * -t2Re_1m);
        float T2x2eRe = (x3eRe_4 * -t2Re_1m - -x3eIm_4 *  t2Re_1e);
        float T2x2eIm = (x3eRe_4 *  t2Re_1e + -x3eIm_4 * -t2Re_1m);

        float T2x1fRe = (x1dRe_4 * -t2Re_1l - -x1dIm_4 *  t2Re_1f);
        float T2x1fIm = (x1dRe_4 *  t2Re_1f + -x1dIm_4 * -t2Re_1l);
        float T2x3fRe = (x3dRe_4 * -t2Re_1l - -x3dIm_4 *  t2Re_1f);
        float T2x3fIm = (x3dRe_4 *  t2Re_1f + -x3dIm_4 * -t2Re_1l);

        float T2x0gRe = (x1cRe_4 * -t2Re_1k - -x1cIm_4 *  t2Re_1g);
        float T2x0gIm = (x1cRe_4 *  t2Re_1g + -x1cIm_4 * -t2Re_1k);
        float T2x2gRe = (x3cRe_4 * -t2Re_1k - -x3cIm_4 *  t2Re_1g);
        float T2x2gIm = (x3cRe_4 *  t2Re_1g + -x3cIm_4 * -t2Re_1k);

        float T2x1hRe = (x1bRe_4 * -t2Re_1j - -x1bIm_4 *  t2Re_1h);
        float T2x1hIm = (x1bRe_4 *  t2Re_1h + -x1bIm_4 * -t2Re_1j);
        float T2x3hRe = (x3bRe_4 * -t2Re_1j - -x3bIm_4 *  t2Re_1h);
        float T2x3hIm = (x3bRe_4 *  t2Re_1h + -x3bIm_4 * -t2Re_1j);

       // float res4ReA =  x0aRe_8 + T2x0aRe + ((x2aRe_8 + T2x2aRe)*  t2Re_2i - (( x2aIm_8 + T2x2aIm)*  t2Re_2i)); 

        float res4ReA =  x0aRe_8 + T2x0aRe + ((x2aRe_8 + T2x2aRe)* t2Re_2q  - (( x2aIm_8 + T2x2aIm)*  t2Re_2q ));
        out1024[idx  +  56] =   res4ReA;
        out1024[idx  +  72] =   res4ReA;
        float res4ImA = -x0aIm_8 + T2x0aIm + ((x2aRe_8 + T2x2aRe)* t2Re_2q  + (( x2aIm_8 + T2x2aIm)*  t2Re_2q ));
        out1024[idx  +  73] = - res4ImA;
        out1024[idx  +  57] =   res4ImA;
        float res4ReB =  x0hRe_4 + T2x1bRe + ((x2hRe_4 + T2x3bRe)* t2Re_2p  - (( x2hIm_4 + T2x3bIm)*  t2Re_2r ));
        out1024[idx  +  58] =   res4ReB;
        out1024[idx  +  70] =   res4ReB;
        float res4ImB = -x0hIm_4 + T2x1bIm + ((x2hRe_4 + T2x3bRe)* t2Re_2r  + (( x2hIm_4 + T2x3bIm)*  t2Re_2p ));
        out1024[idx  +  71] = - res4ImB; 
        out1024[idx  +  59] =   res4ImB;
        float res4ReC =  x0gRe_4 + T2x0cRe + ((x2gRe_4 + T2x2cRe)* t2Re_2o  - (( x2gIm_4 + T2x2cIm)*  t2Re_2s ));
        out1024[idx  +  60] =   res4ReC;
        out1024[idx  +  68] =   res4ReC;
        float res4ImC = -x0gIm_4 + T2x0cIm + ((x2gRe_4 + T2x2cRe)* t2Re_2s  + (( x2gIm_4 + T2x2cIm)*  t2Re_2o ));
        out1024[idx  +  69] = - res4ImC;
        out1024[idx  +  61] =   res4ImC;
        float res4ReD =  x0fRe_4 + T2x1dRe + ((x2fRe_4 + T2x3dRe)* t2Re_2n  - (( x2fIm_4 + T2x3dIm)*  t2Re_2t ));
        out1024[idx  +  62] =   res4ReD;
        out1024[idx  +  66] =   res4ReD;
        float res4ImD = -x0fIm_4 + T2x1dIm + ((x2fRe_4 + T2x3dRe)* t2Re_2t  + (( x2fIm_4 + T2x3dIm)*  t2Re_2n ));
        out1024[idx  +  67] = - res4ImD;
        out1024[idx  +  63] =   res4ImD;

        float res4ReE =  x0eRe_4 + T2x0eRe + ((x2eRe_4 + T2x2eRe)* t2Re_2m  - (( x2eIm_4 + T2x2eIm)*  t2Re_2u ));
        out1024[idx  +  ] =   res4ReE;
        out1024[idx  +  ] =   res4ReE;
        float res4ImE = -x0eIm_4 + T2x0eIm + ((x2eRe_4 + T2x2eRe)* t2Re_2u  + (( x2eIm_4 + T2x2eIm)*  t2Re_2m ));
        out1024[idx  +  ] = - res4ImE;
        out1024[idx  +  ] =   res4ImE;
        float res4ReF =  x0dRe_4 + T2x1fRe + ((x2dRe_4 + T2x3fRe)* t2Re_2l  - (( x2dIm_4 + T2x3fIm)*  t2Re_2v ));
        out1024[idx  +  ] =   res4ReF;
        out1024[idx  +  ] =   res4ReF;
        float res4ImF = -x0dIm_4 + T2x1fIm + ((x2dRe_4 + T2x3fRe)* t2Re_2v  + (( x2dIm_4 + T2x3fIm)*  t2Re_2l ));
        out1024[idx  +  ] = - res4ImF; 
        out1024[idx  +  ] =   res4ImF;
        float res4ReG =  x0cRe_4 + T2x0gRe + ((x2cRe_4 + T2x2gRe)* t2Re_2k  - (( x2cIm_4 + T2x2gIm)*  t2Re_2w ));
        out1024[idx  +  ] =   res4ReG;
        out1024[idx  +  ] =   res4ReG;
        float res4ImG = -x0cIm_4 + T2x0gIm + ((x2cRe_4 + T2x2gRe)* t2Re_2w  + (( x2cIm_4 + T2x2gIm)*  t2Re_2k ));
        out1024[idx  +  ] = - res4ImG;
        out1024[idx  +  ] =   res4ImG;
        float res4ReH =  x0bRe_4 + T2x1hRe + ((x2bRe_4 + T2x3hRe)* t2Re_2j  - (( x2bIm_4 + T2x3hIm)*  t2Re_2x ));
        out1024[idx  +  ] =   res4ReH;
        out1024[idx  +  ] =   res4ReH;
        float res4ImH = -x0bIm_4 + T2x1hIm + ((x2bRe_4 + T2x3hRe)* t2Re_2x  + (( x2bIm_4 + T2x3hIm)*  t2Re_2j ));
        out1024[idx  +  ] = - res4ImH;
        out1024[idx  +  ] =   res4ImH;
        ...
        float res5ReA =  x0aRe_8 - T2x0aRe + ((x2aRe_8 - T2x2aRe)* -t2Re_2q  - ((-x2aIm_8 - T2x2aIm)*  t2Re_2q ));
        out1024[idx  +  56] =   res5ReA;
        out1024[idx  +  72] =   res5ReA;
        float res5ImA = -x0aIm_8 - T2x0aIm + ((x2aRe_8 - T2x2aRe)*  t2Re_2q  + ((-x2aIm_8 - T2x2aIm)* -t2Re_2q ));
        out1024[idx  +  73] = - res5ImA;
        out1024[idx  +  57] =   res5ImA;
        float res5ReB =  x0hRe_4 - T2x1bRe + ((x2hRe_4 - T2x3bRe)* -t2Re_2p  - ((-x2hIm_4 - T2x3bIm)*  t2Re_2r ));
        out1024[idx  +  58] =   res5ReB;
        out1024[idx  +  70] =   res5ReB;
        float res5ImB = -x0hIm_4 - T2x1bIm + ((x2hRe_4 - T2x3bRe)*  t2Re_2r  + ((-x2hIm_4 - T2x3bIm)* -t2Re_2p ));
        out1024[idx  +  71] = - res5ImB; 
        out1024[idx  +  59] =   res5ImB;
        float res5ReC =  x0gRe_4 - T2x0cRe + ((x2gRe_4 - T2x2cRe)* -t2Re_2o  - ((-x2gIm_4 - T2x2cIm)*  t2Re_2s ));
        out1024[idx  +  60] =   res5ReC;
        out1024[idx  +  68] =   res5ReC;
        float res5ImC = -x0gIm_4 - T2x0cIm + ((x2gRe_4 - T2x2cRe)*  t2Re_2s  + ((-x2gIm_4 - T2x2cIm)* -t2Re_2o ));
        out1024[idx  +  69] = - res5ImC;
        out1024[idx  +  61] =   res5ImC;
        float res5ReD =  x0fRe_4 - T2x1dRe + ((x2fRe_4 - T2x3dRe)* -t2Re_2n  - ((-x2fIm_4 - T2x3dIm)*  t2Re_2t ));
        out1024[idx  +  62] =   res5ReD;
        out1024[idx  +  66] =   res5ReD;
        float res5ImD = -x0fIm_4 - T2x1dIm + ((x2fRe_4 - T2x3dRe)*  t2Re_2t  + ((-x2fIm_4 - T2x3dIm)* -t2Re_2n ));
        out1024[idx  +  67] = - res5ImD;
        out1024[idx  +  63] =   res5ImD;

        float res5ReE =  x0eRe_4 - T2x0eRe + ((x2eRe_4 - T2x2eRe)* -t2Re_2m  - ((-x2eIm_4 - T2x2eIm)*  t2Re_2u ));
        out1024[idx  +  ] =   res5ReE;
        out1024[idx  +  ] =   res5ReE;
        float res5ImE = -x0eIm_4 - T2x0eIm + ((x2eRe_4 - T2x2eRe)*  t2Re_2u  + ((-x2eIm_4 - T2x2eIm)* -t2Re_2m ));
        out1024[idx  +  ] = - res5ImE;
        out1024[idx  +  ] =   res5ImE;
        float res5ReF =  x0dRe_4 - T2x1fRe + ((x2dRe_4 - T2x3fRe)* -t2Re_2l  - ((-x2dIm_4 - T2x3fIm)*  t2Re_2v ));
        out1024[idx  +  ] =   res5ReF;
        out1024[idx  +  ] =   res5ReF;
        float res5ImF = -x0dIm_4 - T2x1fIm + ((x2dRe_4 - T2x3fRe)*  t2Re_2v  + ((-x2dIm_4 - T2x3fIm)* -t2Re_2l ));
        out1024[idx  +  ] = - res5ImF; 
        out1024[idx  +  ] =   res5ImF;
        float res5ReG =  x0cRe_4 - T2x0gRe + ((x2cRe_4 - T2x2gRe)* -t2Re_2k  - ((-x2cIm_4 - T2x2gIm)*  t2Re_2w ));
        out1024[idx  +  ] =   res5ReG;
        out1024[idx  +  ] =   res5ReG;
        float res5ImG = -x0cIm_4 - T2x0gIm + ((x2cRe_4 - T2x2gRe)*  t2Re_2w  + ((-x2cIm_4 - T2x2gIm)* -t2Re_2k ));
        out1024[idx  +  ] = - res5ImG;
        out1024[idx  +  ] =   res5ImG;
        float res5ReH =  x0bRe_4 - T2x1hRe + ((x2bRe_4 - T2x3hRe)* -t2Re_2j  - ((-x2bIm_4 - T2x3hIm)*  t2Re_2x ));
        out1024[idx  +  ] =   res5ReH;
        out1024[idx  +  ] =   res5ReH;
        float res5ImH = -x0bIm_4 - T2x1hIm + ((x2bRe_4 - T2x3hRe)*  t2Re_2x  + ((-x2bIm_4 - T2x3hIm)* -t2Re_2j ));
        out1024[idx  +  ] = - res5ImH;
        out1024[idx  +  ] =   res5ImH;



        float T3x0aRe = (x1aRe_4  * -t2Re_1i - -x1aIm_4 *  t2Re_1i);
        float T3x0aIm = (x1aRe_4  *  t2Re_1i + -x1aIm_4 * -t2Re_1i);
        float T3x2aRe = (x3aRe_4  * -t2Re_1i - -x3aIm_4 *  t2Re_1i);
        float T3x2aIm = (x3aRe_4  *  t2Re_1i + -x3aIm_4 * -t2Re_1i);

        float T3x1bRe = (x1hRe_0  * -t2Re_1h - -x1hIm_0 *  t2Re_1j);
        float T3x1bIm = (x1hRe_0  *  t2Re_1j + -x1hIm_0 * -t2Re_1h);
        float T3x3bRe = (x3hRe_0  * -t2Re_1h - -x3hIm_0 *  t2Re_1j);
        float T3x3bIm = (x3hRe_0  *  t2Re_1j + -x3hIm_0 * -t2Re_1h);

        float T3x0cRe = (x1gRe_0  * -t2Re_1g - -x1gIm_0 *  t2Re_1k);
        float T3x0cIm = (x1gRe_0  *  t2Re_1k + -x1gIm_0 * -t2Re_1g);
        float T3x2cRe = (x3gRe_0  * -t2Re_1g - -x3gIm_0 *  t2Re_1k);
        float T3x2cIm = (x3gRe_0  *  t2Re_1k + -x3gIm_0 * -t2Re_1g);

        float T3x1dRe = (x1fRe_0  * -t2Re_1f - -x1fIm_0 *  t2Re_1l);
        float T3x1dIm = (x1fRe_0  *  t2Re_1l + -x1fIm_0 * -t2Re_1f);
        float T3x3dRe = (x3fRe_0  * -t2Re_1f - -x3fIm_0 *  t2Re_1l);
        float T3x3dIm = (x3fRe_0  *  t2Re_1l + -x3fIm_0 * -t2Re_1f);


        float T3x0eRe = (x1eRe_0  * -t2Re_1e - -x1eIm_0 *  t2Re_1m);
        float T3x0eIm = (x1eRe_0  *  t2Re_1m + -x1eIm_0 * -t2Re_1e);
        float T3x2eRe = (x3eRe_0  * -t2Re_1e - -x3eIm_0 *  t2Re_1m);
        float T3x2eIm = (x3eRe_0  *  t2Re_1m + -x3eIm_0 * -t2Re_1e);

        float T3x1fRe = (x1dRe_0  * -t2Re_1d - -x1dIm_0 *  t2Re_1n);
        float T3x1fIm = (x1dRe_0  *  t2Re_1n + -x1dIm_0 * -t2Re_1d);
        float T3x3fRe = (x3dRe_0  * -t2Re_1d - -x3dIm_0 *  t2Re_1n);
        float T3x3fIm = (x3dRe_0  *  t2Re_1n + -x3dIm_0 * -t2Re_1d);

        float T3x0gRe = (x1cRe_0  * -t2Re_1c - -x1cIm_0 *  t2Re_1o);
        float T3x0gIm = (x1cRe_0  *  t2Re_1o + -x1cIm_0 * -t2Re_1c);
        float T3x2gRe = (x3cRe_0  * -t2Re_1c - -x3cIm_0 *  t2Re_1o);
        float T3x2gIm = (x3cRe_0  *  t2Re_1o + -x3cIm_0 * -t2Re_1c);

        float T3x1hRe = (x1bRe_0  * -t2Re_1b - -x1bIm_0 *  t2Re_1p);
        float T3x1hIm = (x1bRe_0  *  t2Re_1p + -x1bIm_0 * -t2Re_1b);
        float T3x3hRe = (x3bRe_0  * -t2Re_1b - -x3bIm_0 *  t2Re_1p);
        float T3x3hIm = (x3bRe_0  *  t2Re_1p + -x3bIm_0 * -t2Re_1b);



        float res6ReA =  x0aRe_4 + T3x0aRe + ((x2aRe_4 + T3x2aRe)*  t2Re_2i - ((-x2aIm_4 + T3x2aIm)*  t2Re_2y));  
        out1024[idx  +  24] =   res6ReA;
        out1024[idx  + 104] =   res6ReA;
        float res6ImA = -x0aIm_4 + T3x0aIm + ((x2aRe_4 + T3x2aRe)*  t2Re_2y + ((-x2aIm_4 + T3x2aIm)*  t2Re_2i)); 
        out1024[idx  + 105] = - res6ImA; 
        out1024[idx  +  25] =   res6ImA;
        float res6ReB =  x0hRe_0 + T3x1bRe + ((x2hRe_0 + T3x3bRe)*  t2Re_2h - ((-x2hIm_0 + T3x3bIm)*  t2Re_2z)); 
        out1024[idx  +  26] =   res6ReB;
        out1024[idx  + 102] =   res6ReB;
        float res6ImB = -x0hIm_0 + T3x1bIm + ((x2hRe_0 + T3x3bRe)*  t2Re_2z + ((-x2hIm_0 + T3x3bIm)*  t2Re_2h)); 
        out1024[idx  + 103] = - res6ImB; 
        out1024[idx  +  27] =   res6ImB; 
        float res6ReC =  x0gRe_0 + T3x0cRe + ((x2gRe_0 + T3x2cRe)*  t2Re_2g - ((-x2gIm_0 + T3x2cIm)*  t2Re_2aa));  
        out1024[idx  +  28] =   res6ReC;
        out1024[idx  + 100] =   res6ReC;
        float res6ImC = -x0gIm_0 + T3x0cIm + ((x2gRe_0 + T3x2cRe)*  t2Re_2aa + ((-x2gIm_0 + T3x2cIm)*  t2Re_2g)); 
        out1024[idx  + 101] = - res6ImC; 
        out1024[idx  +  29] =   res6ImC; 
        float res6ReD =  x0fRe_0 + T3x1dRe + ((x2fRe_0 + T3x3dRe)*  t2Re_2f - ((-x2fIm_0 + T3x3dIm)*  t2Re_2ab)); 
        out1024[idx  +  30] =   res6ReD;
        out1024[idx  +  98] =   res6ReD; 
        float res6ImD = -x0fIm_0 + T3x1dIm + ((x2fRe_0 + T3x3dRe)*  t2Re_2ab + ((-x2fIm_0 + T3x3dIm)*  t2Re_2f)); 
        out1024[idx  +  99] = - res6ImD;
        out1024[idx  +  31] =   res6ImD;

        float res6ReE =  x0eRe_0 + T3x0eRe + ((x2eRe_0 + T3x2eRe)*  t2Re_2e - ((-x2eIm_0 + T3x2eIm)*  t2Re_2ac));  
        out1024[idx  +  ] =   res6ReE;
        out1024[idx  +  ] =   res6ReE;
        float res6ImE = -x0eIm_0 + T3x0eIm + ((x2eRe_0 + T3x2eRe)*  t2Re_2ac + ((-x2eIm_0 + T3x2eIm)*  t2Re_2e)); 
        out1024[idx  +  ] = - res6ImE; 
        out1024[idx  +  ] =   res6ImE;
        float res6ReF =  x0dRe_0 + T3x1fRe + ((x2dRe_0 + T3x3fRe)*  t2Re_2d - ((-x2dIm_0 + T3x3fIm)*  t2Re_2ad); 
        out1024[idx  +  ] =   res6ReF;
        out1024[idx  +  ] =   res6ReF;
        float res6ImF = -x0dIm_0 + T3x1fIm + ((x2dRe_0 + T3x3fRe)*  t2Re_2ad + ((-x2dIm_0 + T3x3fIm)*  t2Re_2d)); 
        out1024[idx  +  ] = - res6ImF; 
        out1024[idx  +  ] =   res6ImF; 
        float res6ReG =  x0cRe_0 + T3x0gRe + ((x2cRe_0 + T3x2gRe)*  t2Re_2c - ((-x2cIm_0 + T3x2gIm)*  t2Re_2ae));  
        out1024[idx  +  ] =   res6ReG;
        out1024[idx  +  ] =   res6ReG;
        float res6ImG = -x0cIm_0 + T3x0gIm + ((x2cRe_0 + T3x2gRe)*  t2Re_2ae + ((-x2cIm_0 + T3x2gIm)*  t2Re_2c)); 
        out1024[idx  +  ] = - res6ImG; 
        out1024[idx  +  ] =   res6ImG; 
        float res6ReH =  x0bRe_0 + T3x1hRe + ((x2bRe_0 + T3x3hRe)*  t2Re_2b - ((-x2bIm_0 + T3x3hIm)*  t2Re_af)); 
        out1024[idx  +  ] =   res6ReH;
        out1024[idx  +  ] =   res6ReH; 
        float res6ImH = -x0bIm_0 + T3x1hIm + ((x2bRe_0 + T3x3hRe)*  t2Re_2af + ((-x2bIm_0 + T3x3hIm)*  t2Re_2b)); 
        out1024[idx  +  ] = - res6ImH;
        out1024[idx  +  ] =   res6ImH;
        ...
        float res7ReA =  x0aRe_4 - T3x0aRe + ((x2aRe_4 - T3x2aRe)* -t2Re_2i  - ((-x2aIm_4 - T3x2aIm)*  t2Re_2y ));
        out1024[idx  +  56] =   res7ReA;
        out1024[idx  +  72] =   res7ReA;
        float res7ImA = -x0aIm_4 - T3x0aIm + ((x2aRe_4 - T3x2aRe)*  t2Re_2y  + ((-x2aIm_4 - T3x2aIm)* -t2Re_2i ));
        out1024[idx  +  73] = - res7ImA;
        out1024[idx  +  57] =   res7ImA;
        float res7ReB =  x0hRe_0 - T3x1bRe + ((x2hRe_0 - T3x3bRe)* -t2Re_2h  - ((-x2hIm_0 - T3x3bIm)*  t2Re_2z ));
        out1024[idx  +  58] =   res7ReB;
        out1024[idx  +  70] =   res7ReB;
        float res7ImB = -x0hIm_0 - T3x1bIm + ((x2hRe_0 - T3x3bRe)*  t2Re_2z  + ((-x2hIm_0 - T3x3bIm)* -t2Re_2h ));
        out1024[idx  +  71] = - res7ImB; 
        out1024[idx  +  59] =   res7ImB;
        float res7ReC =  x0gRe_0 - T3x0cRe + ((x2gRe_0 - T3x2cRe)* -t2Re_2g  - ((-x2gIm_0 - T3x2cIm)*  t2Re_2aa ));
        out1024[idx  +  60] =   res7ReC;
        out1024[idx  +  68] =   res7ReC;
        float res7ImC = -x0gIm_0 - T3x0cIm + ((x2gRe_0 - T3x2cRe)*  t2Re_2aa  + ((-x2gIm_0 - T3x2cIm)* -t2Re_2g ));
        out1024[idx  +  69] = - res7ImC;
        out1024[idx  +  61] =   res7ImC;
        float res7ReD =  x0fRe_0 - T3x1dRe + ((x2fRe_0 - T3x3dRe)* -t2Re_2f  - ((-x2fIm_0 - T3x3dIm)*  t2Re_2ab ));
        out1024[idx  +  62] =   res7ReD;
        out1024[idx  +  66] =   res7ReD;
        float res7ImD = -x0fIm_0 - T3x1dIm + ((x2fRe_0 - T3x3dRe)*  t2Re_2ab  + ((-x2fIm_0 - T3x3dIm)* -t2Re_2f ));
        out1024[idx  +  67] = - res7ImD;
        out1024[idx  +  63] =   res7ImD;

        float res7ReE =  x0eRe_0 - T3x0eRe + ((x2eRe_0 - T3x2eRe)* -t2Re_2e  - ((-x2eIm_0 - T3x2eIm)*  t2Re_2ac ));
        out1024[idx  +  ] =   res7ReE;
        out1024[idx  +  ] =   res7ReE;
        float res7ImE = -x0eIm_0 - T3x0eIm + ((x2eRe_0 - T3x2eRe)*  t2Re_2ac  + ((-x2eIm_0 - T3x2eIm)* -t2Re_2e ));
        out1024[idx  +  ] = - res7ImE;
        out1024[idx  +  ] =   res7ImE;
        float res7ReF =  x0dRe_0 - T3x1fRe + ((x2dRe_0 - T3x3fRe)* -t2Re_2d  - ((-x2dIm_0 - T3x3fIm)*  t2Re_2ad ));
        out1024[idx  +  ] =   res7ReF;
        out1024[idx  +  ] =   res7ReF;
        float res7ImF = -x0dIm_0 - T3x1fIm + ((x2dRe_0 - T3x3fRe)*  t2Re_2ad  + ((-x2dIm_0 - T3x3fIm)* -t2Re_2d ));
        out1024[idx  +  ] = - res7ImF; 
        out1024[idx  +  ] =   res7ImF;
        float res7ReG =  x0cRe_0 - T3x0gRe + ((x2cRe_0 - T3x2gRe)* -t2Re_2c  - ((-x2cIm_0 - T3x2gIm)*  t2Re_2ae ));
        out1024[idx  +  ] =   res7ReG;
        out1024[idx  +  ] =   res7ReG;
        float res7ImG = -x0cIm_0 - T3x0gIm + ((x2cRe_0 - T3x2gRe)*  t2Re_2ae  + ((-x2cIm_0 - T3x2gIm)* -t2Re_2c ));
        out1024[idx  +  ] = - res7ImG;
        out1024[idx  +  ] =   res7ImG;
        float res7ReH =  x0bRe_0 - T3x1hRe + ((x2bRe_0 - T3x3hRe)* -t2Re_2b  - ((-x2bIm_0 - T3x3hIm)*  t2Re_2af ));
        out1024[idx  +  ] =   res7ReH;
        out1024[idx  +  ] =   res7ReH;
        float res7ImH = -x0bIm_0 - T3x1hIm + ((x2bRe_0 - T3x3hRe)*  t2Re_2af  + ((-x2bIm_0 - T3x3hIm)* -t2Re_2b ));
        out1024[idx  +  ] = - res7ImH;
        out1024[idx  +  ] =   res7ImH;
...
*/
    ...
    for(int idx = 0; idx < 2048; idx += 256){ 
        ...
        float tRe1 = 0x1.ff621ep-1;
        float tRe31 = 0x1.91f652p-5;
        ...
        float tRe2 = 0x1.fd88dap-1;
        float tRe30 = 0x1.917a6ap-4;
        ...
        float tRe3 = 0x1.fa7558p-1;
        float tRe29 = 0x1.2c810ap-3;
        ...
        float tRe4 = 0x1.f6297cp-1;
        float tRe28 = 0x1.8f8b88p-3;
        ...
        float tRe5 = 0x1.f0a7fp-1;
        float tRe27 = 0x1.f19fap-3;
        ...
        float tRe6 = 0x1.e9f416p-1;
        float tRe26 = 0x1.29406p-2;
        ...
        float tRe7 = 0x1.e2121p-1;
        float tRe25 = 0x1.58f9a6p-2;
        ...
        float tRe8 = 0x1.d906bcp-1;
        float tRe24 = 0x1.87de2ap-2;
        ...
        float tRe9 = 0x1.ced7bp-1;
        float tRe23 = 0x1.b5d102p-2;
        ...
        float tRe10 = 0x1.c38b3p-1;
        float tRe22 = 0x1.e2b5d6p-2;
        ...
        float tRe11 = 0x1.b72834p-1;
        float tRe21 = 0x1.07387cp-1;
        ...
        float tRe12 = 0x1.a9b662p-1;
        float tRe20 = 0x1.1c73b4p-1;
        ...
        float tRe13 = 0x1.9b3e04p-1;
        float tRe19 = 0x1.30ff8p-1;
        ...
        float tRe14 = 0x1.8bc808p-1;
        float tRe18 = 0x1.44cf32p-1;
        ...
        float tRe15 = 0x1.7b5df2p-1;
        float tRe17 = 0x1.57d694p-1;
    ...
    for(int idx = 0; idx < 2048; idx += 512){ 
        ...
        float eRe1 = out1024[idx + 2];
        float eIm1 = out1024[idx + 3];
        float tRe1 = 0x1.ffd886p-1;
        float tRe63 = 0x1.92157cp-6;
        ...
        float eRe2 = out1024[idx + 4];
        float eIm2 = out1024[idx + 5];
        float tRe2 = 0x1.ff621ep-1;
        float tRe62 = 0x1.91f652p-5;
        ...
        float eRe3 = out1024[idx + 6];
        float eIm3 = out1024[idx + 7];
        float tRe3 = 0x1.fe9cdap-1;
        float tRe61 = 0x1.2d5216p-4;
        ...
        float eRe4 = out1024[idx + 8];
        float eIm4 = out1024[idx + 9];
        float tRe4 = 0x1.fd88dap-1;
        float tRe60 = 0x1.917a6ap-4;
        ...
        float eRe5 = out1024[idx + 10];
        float eIm5 = out1024[idx + 11];
        float tRe5 = 0x1.fc2648p-1;
        float tRe59 = 0x1.f564d8p-4;
        ...
        float eRe6 = out1024[idx + 12];
        float eIm6 = out1024[idx + 13];
        float tRe6 = 0x1.fa7558p-1;
        float tRe58 = 0x1.2c810ap-3;
        ...
        float eRe7 = out1024[idx + 14];
        float eIm7 = out1024[idx + 15];
        float tRe7 = 0x1.f8765p-1;
        float tRe57 = 0x1.5e214p-3;
        ...
        float eRe8 = out1024[idx + 16];
        float eIm8 = out1024[idx + 17];
        float tRe8 = 0x1.f6297cp-1;
        float tRe56 = 0x1.8f8b88p-3;
        ...
        float eRe9 = out1024[idx + 18];
        float eIm9 = out1024[idx + 19];
        float tRe9 = 0x1.f38f3ap-1;
        float tRe55 = 0x1.c0b824p-3;
        ...
        float eRe10 = out1024[idx + 20];
        float eIm10 = out1024[idx + 21];
        float tRe10 = 0x1.f0a7fp-1;
        float tRe54 = 0x1.f19fap-3;
        ...
        float eRe11 = out1024[idx + 22];
        float eIm11 = out1024[idx + 23];
        float tRe11 = 0x1.ed740ep-1;
        float tRe53 = 0x1.111d26p-2;
        ...
        float eRe12 = out1024[idx + 24];
        float eIm12 = out1024[idx + 25];
        float tRe12 = 0x1.e9f416p-1;
        float tRe52 = 0x1.29406p-2;
        ...
        float eRe13 = out1024[idx + 26];
        float eIm13 = out1024[idx + 27];
        float tRe13 = 0x1.e6288ep-1;
        float tRe51 = 0x1.4135cap-2;
        ...
        float eRe14 = out1024[idx + 28];
        float eIm14 = out1024[idx + 29];
        float tRe14 = 0x1.e2121p-1;
        float tRe50 = 0x1.58f9a6p-2;
        ...
        float eRe15 = out1024[idx + 30];
        float eIm15 = out1024[idx + 31];
        float tRe15 = 0x1.ddb13cp-1;
        float tRe49 = 0x1.708856p-2;
        ...
        float eRe16 = out1024[idx + 32];
        float eIm16 = out1024[idx + 33];
        float tRe16 = 0x1.d906bcp-1;
        float tRe48 = 0x1.87de2ap-2;
        ...
        float eRe17 = out1024[idx + 34];
        float eIm17 = out1024[idx + 35];
        float tRe17 = 0x1.d4134ep-1;
        float tRe47 = 0x1.9ef792p-2;
        ...
        float eRe18 = out1024[idx + 36];
        float eIm18 = out1024[idx + 37];
        float tRe18 = 0x1.ced7bp-1;
        float tRe46 = 0x1.b5d102p-2;
        ...
        float eRe19 = out1024[idx + 38];
        float eIm19 = out1024[idx + 39];
        float tRe19 = 0x1.c954b2p-1;
        float tRe45 = 0x1.cc66e8p-2;
        ...
        float eRe20 = out1024[idx + 40];
        float eIm20 = out1024[idx + 41];
        float tRe20 = 0x1.c38b3p-1;
        float tRe44 = 0x1.e2b5d6p-2;
        ...
        float eRe21 = out1024[idx + 42];
        float eIm21 = out1024[idx + 43];
        float tRe21 = 0x1.bd7c0cp-1;
        float tRe43 = 0x1.f8ba4ep-2;
        ...
        float eRe22 = out1024[idx + 44];
        float eIm22 = out1024[idx + 45];
        float tRe22 = 0x1.b72834p-1;
        float tRe42 = 0x1.07387cp-1;
        ...
        float eRe23 = out1024[idx + 46];
        float eIm23 = out1024[idx + 47];
        float tRe23 = 0x1.b090a6p-1;
        float tRe41 = 0x1.11eb36p-1;
        ...
        float eRe24 = out1024[idx + 48];
        float eIm24 = out1024[idx + 49];
        float tRe24 = 0x1.a9b662p-1;
        float tRe40 = 0x1.1c73b4p-1;
        ...
        float eRe25 = out1024[idx + 50];
        float eIm25 = out1024[idx + 51];
        float tRe25 = 0x1.a29a7ap-1;
        float tRe39 = 0x1.26d056p-1;
        ...
        float eRe26 = out1024[idx + 52];
        float eIm26 = out1024[idx + 53];
        float tRe26 = 0x1.9b3e04p-1;
        float tRe38 = 0x1.30ff8p-1;
        ...
        float eRe27 = out1024[idx + 54];
        float eIm27 = out1024[idx + 55];
        float tRe27 = 0x1.93a226p-1;
        float tRe37 = 0x1.3affa2p-1;
        ...
        float eRe28 = out1024[idx + 56];
        float eIm28 = out1024[idx + 57];
        float tRe28 = 0x1.8bc808p-1;
        float tRe36 = 0x1.44cf32p-1;
        ...
        float eRe29 = out1024[idx + 58];
        float eIm29 = out1024[idx + 59];
        float tRe29 = 0x1.83b0ep-1;
        float tRe35 = 0x1.4e6cacp-1;
        ...
        float eRe30 = out1024[idx + 60];
        float eIm30 = out1024[idx + 61];
        float tRe30 = 0x1.7b5df2p-1;
        float tRe34 = 0x1.57d694p-1;
        ...
        float eRe31 = out1024[idx + 62];
        float eIm31 = out1024[idx + 63];
        float tRe31 = 0x1.72d084p-1;
        float tRe33 = 0x1.610b76p-1;
